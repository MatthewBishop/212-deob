...
public final class WallDecoration {
	...
	static void method1305() {
		...
		if (Login.Login_username.length() == 0) {
			Tile.setLoginResponseString("Please enter your username.", "If you created your account after November",
			...
			if (0L == var1) {
				...
				try {
					...
					var15.write("data2=" + class431.method2221(var20) + "&dest="
							+ class431.method2221("passwordchoice.ws"));
					var15.flush();
			...
			case 3:
				...
				break;
			case 4:
				Tile.setLoginResponseString("The part of the website you are trying",
						"to connect to is offline at the moment.", "Please try again later.");
				break;
			case 5:
				Tile.setLoginResponseString("Sorry, there was an error trying to",
			...
			case 6:
				...
				break;
			case 7:
				Tile.setLoginResponseString("You must enter a valid login to proceed. For accounts",
