...
class class11 implements TlsAuthentication {
	...
	public void notifyServerCertificate(Certificate var1) throws IOException {
		try {
			...
			this.this$2.this$1.field38 = (java.security.cert.Certificate[]) ((java.security.cert.Certificate[]) var3
	...
	static void getLoginError(int var0) {
		...
		if (var0 == -3) {
			...
			Login.field725 = 2;
			Tile.setLoginResponseString("Either your account is still logged in, or the last",
			...
			if (var0 == 7) {
				...
				Tile.setLoginResponseString("We suspect someone knows your password.",
						"Press 'change your password' on front page.", "");
			} else if (var0 == 12) {
				Tile.setLoginResponseString("You need a members account to login to this world.",
				...
				Tile.setLoginResponseString("Too many login attempts.",
						"Please wait a few minutes before trying again.", "");
			} else if (var0 == 17) {
				Tile.setLoginResponseString("To access this free world, log into a",
						"members world and move your character", "to a non-members area.");
			} else if (var0 == 18) {
				class14.method52(14);
				Login.field738 = 1;
			} else if (var0 == 19) {
				Tile.setLoginResponseString("This world is running a closed Beta.", "Sorry invited players only.",
				...
				Tile.setLoginResponseString("This computers address has been blocked",
						"as it was used to break our rules.", "");
			} else if (var0 == 27) {
				Tile.setLoginResponseString("", "Service unavailable.", "");
			} else if (var0 == 31) {
				Tile.setLoginResponseString("Your account must have a displayname set",
						"in order to play the game.  Please set it", "via the website, or the main game.");
			} else if (var0 == 32) {
				class14.method52(14);
				Login.field738 = 2;
			} else if (var0 == 37) {
				Tile.setLoginResponseString("Your account is currently inaccessible.",
						"Please try again in a few minutes.", "");
			} else if (var0 == 38) {
				Tile.setLoginResponseString("You need to vote to play!", "Visit runescape.com and vote,",
				...
				if (var0 == 61) {
					...
					if (var0 == 71) {
						class19.updateGameState(10);
						class14.method52(7);
						Tile.setLoginResponseString("There was a problem updating your DOB.",
								"Please try again later. If the problem ", "persists, please contact Jagex Support.");
					} else if (var0 == 73) {
						class19.updateGameState(10);
						class14.method52(6);
						Tile.setLoginResponseString("Your date of birth information is waiting",
	...
	static final void method37() {
		...
		if (class381.cameraX == class364.field3540 && class351.cameraY == Coord.field2766
				&& class471.cameraZ == class307.field2776 && class311.cameraPitch == WorldMapRectangle.field2359
				&& class110.cameraYaw == class28.field84) {
					...
					if (var0.targetIndex > 0) {
						...
						if (var1 != null && var1.x >= 0 && var1.x < 13312 && var1.y >= 0 && var1.y < 13312) {
							var0.setDestination(var1.x, var1.y,
									WorldMapDecorationType.getTileHeight(var1.x, var1.y, var0.plane) - var0.endHeight,
									Client.cycle);
						}
					}
					...
					if (var0.targetIndex < 0) {
						...
						if (var3 != null && var3.x >= 0 && var3.x < 13312 && var3.y >= 0 && var3.y < 13312) {
							var0.setDestination(var3.x, var3.y,
									WorldMapDecorationType.getTileHeight(var3.x, var3.y, var0.plane) - var0.endHeight,
									Client.cycle);
						}
					}

					var0.advance(Client.field504);
					class1.scene.drawEntity(TaskHandler.Client_plane, (int) var0.x, (int) var0.y, (int) var0.z, 60,
							var0, var0.yaw, -1L, false);
				}
			} else {
				var0.remove();
			}
	...
	static final boolean method41(Widget var0) {
		...
		if (var1 == 205) {
			...
			if (var1 == 326) {
				PacketBufferNode var4 = UserComparator9.getPacketBufferNode(ClientPacket.field2454,
