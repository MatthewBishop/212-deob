public class LoginScreenAnimation {
	...
	final void method513(int var1) {
		...
		for (int var5 = 0; var5 < var4; ++var5) {
			var6 = this.field1026[var2 + var3]
					- this.field1023[var2 + this.field1025 & this.field1023.length - 1] * var1 / 6;
			if (var6 < 0) {
				var6 = 0;
			}
		...
		for (var7 = 256 - var1; var7 < 256; ++var7) {
			this.field1013[var7] = (int) (Math.sin((double) this.field1015 / 14.0D) * 16.0D
					+ Math.sin((double) this.field1015 / 15.0D) * 14.0D
					+ Math.sin((double) this.field1015 / 16.0D) * 12.0D);
			++this.field1015;
		}
	...
	final int method518(int var1, int var2, int var3) {
		...
		return (var3 * (var2 & '\uff00') + var4 * (var1 & '\uff00') & 16711680)
				+ (var4 * (var1 & 16711935) + var3 * (var2 & 16711935) & -16711936) >> 8;
	}
		...
		for (int var3 = 1; var3 < 255; ++var3) {
			...
			for (int var9 = var6; var9 < var7; ++var9) {
				...
				if (var10 != 0 && var11 >= Rasterizer2D.Rasterizer2D_xClipStart
					...
					StudioGame.rasterProvider.pixels[var8++] = -16777216
							| (var13 * (var14 & '\uff00') + var12 * (var10 & '\uff00') & 16711680)
									+ ((var14 & 16711935) * var13 + (var10 & 16711935) * var12 & -16711936) >> 8;
				} else {
					++var8;
				}
			}
		...
		for (var2 = 0; var2 < 20; ++var2) {
			for (var3 = 1; var3 < 255; ++var3) {
				for (var4 = 1; var4 < 127; ++var4) {
					var5 = var4 + (var3 << 7);
					this.field1024[var5] = (this.field1023[var5 - 128] + this.field1023[var5 + 1]
							+ this.field1023[var5 + 128] + this.field1023[var5 - 1]) / 4;
				}
			}
