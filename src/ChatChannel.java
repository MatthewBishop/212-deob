...
public class ChatChannel {
	...
	static void method445() {
		try {
			...
			if (var0.exists()) {
				...
				label38: for (int var1 = 0; var1 < StudioGame.cacheSubPaths.length; ++var1) {
					for (var2 = 0; var2 < class164.cacheParentPaths.length; ++var2) {
						File var3 = new File(class164.cacheParentPaths[var2] + StudioGame.cacheSubPaths[var1]
	...
	static int method448(int var0, Script var1, boolean var2) {
		...
		if (var0 == 3100) {
			...
			Language.performPlayerAnimation(BuddyRankComparator.localPlayer,
			...
			if (var0 == 3104) {
				...
				PacketBufferNode var12 = UserComparator9.getPacketBufferNode(ClientPacket.field2429,
				...
				if (var0 == 3105) {
					var3 = Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize];
					var14 = UserComparator9.getPacketBufferNode(ClientPacket.field2474,
							Client.packetWriter.isaacCipher);
					...
					var3 = Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize];
					var14 = UserComparator9.getPacketBufferNode(ClientPacket.field2501,
							Client.packetWriter.isaacCipher);
					var14.packetBuffer.writeByte(var3.length() + 1);
					var14.packetBuffer.writeStringCp1252NullTerminated(var3);
					Client.packetWriter.addNode(var14);
					...
					if (var0 == 3107) {
						...
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = WorldMapSectionType.clientPreferences.getRoofsHidden() ? 1 : 0;
						return 1;
					} else if (var0 == 3112) {
						WorldMapSectionType.clientPreferences.setRoofsHidden(
								Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1);
						return 1;
					} else if (var0 == 3113) {
						var3 = Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize];
						...
						var8 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
						var14 = UserComparator9.getPacketBufferNode(ClientPacket.field2510,
								Client.packetWriter.isaacCipher);
						...
						if (var7.length() > 500) {
							...
							PacketBufferNode var6 = UserComparator9.getPacketBufferNode(ClientPacket.field2505,
									Client.packetWriter.isaacCipher);
							var6.packetBuffer.writeShort(1 + WorldMapLabel.stringCp1252NullTerminatedByteSize(var7)
									+ WorldMapLabel.stringCp1252NullTerminatedByteSize(var5));
						...
						ClanSettings.setTapToDrop(
								Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1);
						return 1;
					} else if (var0 == 3128) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = Coord
								.getTapToDrop() ? 1 : 0;
						return 1;
					} else if (var0 == 3129) {
						Interpreter.Interpreter_intStackSize -= 2;
						...
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = GameEngine.canvasWidth;
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = class143.canvasHeight;
						return 1;
					} else if (var0 == 3133) {
						--Interpreter.Interpreter_intStackSize;
						return 1;
						...
						Client.field521 = 3;
						Client.field635 = var2 ? GameObject.scriptDotWidget.id * -672060695 * -1052750503
								: SoundSystem.scriptActiveWidget.id * -672060695 * -1052750503;
						return 1;
					} else {
						boolean var15;
						if (var0 == 3141) {
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = WorldMapSectionType.clientPreferences.getIsUsernameHidden() ? 1 : 0;
							return 1;
						} else if (var0 == 3143) {
							var15 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize] == 1;
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
									- 1] = WorldMapSectionType.clientPreferences.getTitleMusicDisabled() ? 0 : 1;
							return 1;
						} else if (var0 == 3148) {
							return 1;
						} else if (var0 == 3149) {
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class13
									.method48();
							return 1;
						} else if (var0 == 3155) {
							...
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = NetCache
									.method1853();
							return 1;
						} else if (var0 == 3189) {
							var8 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
