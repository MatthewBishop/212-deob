	...
	public int percentage() {
		if (this.field3415 == 1 || this.field3421 && this.field3415 == 2) {
			...
			if (class133.NetCache_currentResponse != null && class133.NetCache_currentResponse.key == var3) {
				var1 = NetCache.NetCache_responseArchiveBuffer.offset * 99
		...
		if (var1 == this.masterDisk) {
			...
			if (var3 == null || var3.length <= 2) {
				...
				if (this.field3416 || var4) {
					DevicePcmPlayerProvider.requestNetFile(this, this.index, var2, super.groupCrcs[var2], (byte) 2,
							var4);
				}
	...
	int groupLoadPercent(int var1) {
		if (super.groups[var1] != null) {
			...
			if (class133.NetCache_currentResponse != null && class133.NetCache_currentResponse.key == var4) {
				var2 = NetCache.NetCache_responseArchiveBuffer.offset * 99
						/ (NetCache.NetCache_responseArchiveBuffer.array.length
								- class133.NetCache_currentResponse.padding)
						+ 1;
			} else {
