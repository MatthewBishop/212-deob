public class Rasterizer3D extends Rasterizer2D {
	...
	public static void method1174(int var0, int var1, int var2) {
		field1962 = var0 < 0 || var0 > Rasterizer3D_clipWidth || var1 < 0 || var1 > Rasterizer3D_clipWidth || var2 < 0
				|| var2 > Rasterizer3D_clipWidth;
	}

	static final void method1156(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7,
			int var8) {
		int var9 = var4 - var3;
		int var10 = var1 - var0;
		int var11 = var5 - var3;
				...
				if (var0 < var1) {
					...
					if (var15 < var17) {
						...
						while (true) {
							...
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var4 >> 14, var5 >> 14,
									var8, var19);
							var4 += var15;
							var5 += var17;
							var8 += var20;
						...
						while (true) {
							...
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var5 >> 14, var4 >> 14,
									var8, var19);
							var4 += var15;
							var5 += var17;
							var8 += var20;
					...
					if (var15 < var17) {
						...
						while (true) {
							...
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var3 >> 14, var5 >> 14,
									var8, var19);
							var3 += var15;
							var5 += var17;
							var8 += var20;
						...
						while (true) {
							...
							Rasterizer3D_vertAlpha(Rasterizer2D.Rasterizer2D_pixels, var2, 0, 0, var5 >> 14, var3 >> 14,
									var8, var19);
							var3 += var15;
							var5 += var17;
							var8 += var20;
	...
	static final void method1166(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7,
			int var8, byte var9, byte var10, byte var11, byte var12) {
	...
	static final void Rasterizer3D_vertAlpha(int[] var0, int var1, int var2, int var3, int var4, int var5, int var6,
			int var7) {
		if (field1962) {
				...
				if (Rasterizer3D_alpha == 0) {
					...
					if (var3 > 0) {
						do {
							...
							var11 = var0[var1];
							var0[var1++] = ((var11 & 16711935) * var8 >> 8 & 16711935) + var2
									+ (var8 * (var11 & '\uff00') >> 8 & '\uff00');
							var11 = var0[var1];
							var0[var1++] = ((var11 & 16711935) * var8 >> 8 & 16711935) + var2
									+ (var8 * (var11 & '\uff00') >> 8 & '\uff00');
	...
	static final void method1169(int var0, int var1, int var2, int var3, int var4, int var5, int var6, byte var7,
					...
					while (true) {
						...
						if (var3 < 0) {
							...
							while (true) {
								...
								var8 = var0[var1];
								var0[var1++] = ((var8 & 16711935) * var6 >> 8 & 16711935) + var2
										+ (var6 * (var8 & '\uff00') >> 8 & '\uff00');
							}
						}
	...
	static final void method1176(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7,
		...
		if (var19 == null) {
			...
			method1156(var0, var1, var2, var3, var4, var5, method1162(var20, var6), method1162(var20, var7),
					method1162(var20, var8));
		} else {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
													var5 >> 14, var4 >> 14, var6, var30, var32, var35, var38, var33,
													var36, var39);
											var5 += var28;
											var4 += var27;
											var6 += var31;
								...
								while (true) {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
													var4 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33,
													var36, var39);
											var5 += var28;
											var4 += var27;
											var6 += var31;
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
													var5 >> 14, var3 >> 14, var6, var30, var32, var35, var38, var33,
													var36, var39);
											var5 += var27;
											var3 += var26;
											var6 += var31;
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var0,
													var3 >> 14, var5 >> 14, var6, var30, var32, var35, var38, var33,
													var36, var39);
											var5 += var27;
											var3 += var26;
											var6 += var31;
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
													var5 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33,
													var36, var39);
											var3 += var26;
											var5 += var28;
											var7 += var31;
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
													var3 >> 14, var5 >> 14, var7, var30, var32, var35, var38, var33,
													var36, var39);
											var3 += var26;
											var5 += var28;
											var7 += var31;
								...
								while (true) {
									...
									if (var0 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
													var3 >> 14, var4 >> 14, var7, var30, var32, var35, var38, var33,
													var36, var39);
											var3 += var28;
											var4 += var27;
											var7 += var31;
								...
								while (true) {
									...
									if (var0 < 0) {
										while (true) {
											...
											Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var1,
													var4 >> 14, var3 >> 14, var7, var30, var32, var35, var38, var33,
													var36, var39);
											var3 += var28;
											var4 += var27;
											var7 += var31;
					...
					if (var0 < var1) {
						...
						if (var27 < var28) {
							...
							while (true) {
								...
								Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var4 >> 14,
							...
							while (true) {
								...
								Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var5 >> 14,
						...
						if (var27 < var28) {
							...
							while (true) {
								...
								Rasterizer3D_iDontKnow(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2, var3 >> 14,
										var5 >> 14, var8, var30, var32, var35, var38, var33, var36, var39);
								var3 += var27;
								var5 += var28;
								var8 += var31;
	...
	static final void Rasterizer3D_iDontKnow(int[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6,
	...
	static final void drawTexturedTile(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7,
			int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17,
			int var18) {
		int[] var19 = Rasterizer3D_textureLoader.getTexturePixels(var18);
		int var20;
								...
								while (true) {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var0, var5 >> 14, var4 >> 14, var6, var30, var32, var35, var38,
													var33, var36, var39);
											var5 += var28;
											var4 += var27;
											var6 += var31;
								...
								while (true) {
									...
									if (var1 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var0, var4 >> 14, var5 >> 14, var6, var30, var32, var35, var38,
													var33, var36, var39);
											var5 += var28;
											var4 += var27;
											var6 += var31;
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var0, var3 >> 14, var5 >> 14, var6, var30, var32, var35, var38,
													var33, var36, var39);
											var5 += var27;
											var3 += var26;
											var6 += var31;
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var0, var5 >> 14, var3 >> 14, var6, var30, var32, var35, var38,
													var33, var36, var39);
											var5 += var27;
											var3 += var26;
											var6 += var31;
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var1, var3 >> 14, var5 >> 14, var7, var30, var32, var35, var38,
													var33, var36, var39);
											var3 += var26;
											var5 += var28;
											var7 += var31;
								...
								while (true) {
									...
									if (var2 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var1, var5 >> 14, var3 >> 14, var7, var30, var32, var35, var38,
													var33, var36, var39);
											var3 += var26;
											var5 += var28;
											var7 += var31;
								...
								while (true) {
									...
									if (var0 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var1, var3 >> 14, var4 >> 14, var7, var30, var32, var35, var38,
													var33, var36, var39);
											var3 += var28;
											var4 += var27;
											var7 += var31;
								...
								while (true) {
									...
									if (var0 < 0) {
										while (true) {
											...
											Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0,
													var1, var4 >> 14, var3 >> 14, var7, var30, var32, var35, var38,
													var33, var36, var39);
											var3 += var28;
											var4 += var27;
											var7 += var31;
					...
					if (var0 < var1) {
						...
						if (var27 < var28) {
							...
							while (true) {
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
										var4 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36, var39);
								var4 += var27;
								var5 += var28;
								var8 += var31;
								var2 += Rasterizer2D.Rasterizer2D_width;
							...
							while (true) {
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
										var5 >> 14, var4 >> 14, var8, var30, var32, var35, var38, var33, var36, var39);
								var4 += var27;
								var5 += var28;
								var8 += var31;
								var2 += Rasterizer2D.Rasterizer2D_width;
						...
						if (var27 < var28) {
							...
							while (true) {
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
										var3 >> 14, var5 >> 14, var8, var30, var32, var35, var38, var33, var36, var39);
								var3 += var27;
								var5 += var28;
								var8 += var31;
								var2 += Rasterizer2D.Rasterizer2D_width;
							...
							while (true) {
								...
								Rasterizer3D_textureAlpha(Rasterizer2D.Rasterizer2D_pixels, var19, 0, 0, var2,
										var5 >> 14, var3 >> 14, var8, var30, var32, var35, var38, var33, var36, var39);
								var3 += var27;
								var5 += var28;
								var8 += var31;
								var2 += Rasterizer2D.Rasterizer2D_width;
	...
	static final void Rasterizer3D_textureAlpha(int[] var0, int[] var1, int var2, int var3, int var4, int var5,
