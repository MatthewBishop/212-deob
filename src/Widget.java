...
public class Widget extends Node {
	...
	public SpritePixels getSprite(boolean var1, UrlRequester var2) {
		...
		if (var7 == -1) {
			...
			long var4 = ((long) this.spriteShadow << 40) + (long) var7 + ((long) this.outline << 36)
	...
	SpritePixels method1739(UrlRequester var1) {
		if (!this.method1740()) {
			...
			String var2 = this.field2872 + (this.spriteFlipV ? 1 : 0) + (this.spriteFlipH ? 1 : 0) + this.outline
					+ this.spriteShadow;
	...
	public SpriteMask getSpriteMask(boolean var1) {
		...
		if (var2 == -1) {
			...
			long var3 = ((long) this.outline << 36) + (long) var2 + ((this.spriteFlipV ? 1L : 0L) << 38)
	...
	public int method1761() {
		if (this.type == 11 && this.field2903 != null && this.field2906 != null && !this.field2906.isEmpty()) {
			...
			return var1 != null && this.field2906.containsKey(this.field2903.method871())
					? (Integer) this.field2906.get(var1)
					: -1;
		} else {
			return -1;
		}
			...
			if (var10 != null && (var10.parentId == var1 || var1 == -1412584499 && var10 == Client.clickedWidget)) {
				...
				if (!var10.isIf3 || !WallDecoration.isComponentHidden(var10)) {
					...
					if (!var10.isIf3 || var15 < var17 && var16 < var18) {
						if (var10.contentType != 0) {
							if (var10.contentType == 1336) {
								if (WorldMapSectionType.clientPreferences.method522()) {
									var13 += 15;
									class420.fontPlain12.drawRightAligned("Fps:" + GameEngine.fps, var12 + var10.width,
											var13, 16776960, -1);
									var13 += 15;
									...
									class420.fontPlain12.drawRightAligned("Mem:" + var20 + "k", var12 + var10.width,
											var13, var21, -1);
									var13 += 15;
								}
								continue;
						...
						if (var10.type == 0) {
							if (!var10.isIf3 && WallDecoration.isComponentHidden(var10)
									&& var10 != InvDefinition.mousedOverWidgetIf1) {
								continue;
							}
							...
							if (var28 != null) {
								GrandExchangeOfferOwnWorldComparator.drawWidgets(var28.group, var15, var16, var17,
										var18, var12, var13, var11);
							}
						...
						if (Client.isResizable || Client.field571[var11] || Client.gameDrawingMode > 1) {
							if (var10.type == 0 && !var10.isIf3 && var10.scrollHeight > var10.height) {
								class154.drawScrollBar(var12 + var10.width, var13, var10.scrollY, var10.height,
										var10.scrollHeight);
							}
							...
							if (var10.type != 1) {
								if (var10.type == 3) {
									...
									if (var40 == null) {
										...
										if (JagexCache.runCs1(var10)) {
											var20 = var10.color2;
											if (var10 == InvDefinition.mousedOverWidgetIf1
										...
										if (var10.isIf3 && var10.itemId != -1) {
											...
											if ((var43.isStackable == 1 || var10.itemQuantity != 1)
												...
												var42 = Canvas.colorStartTag(16748608) + var42 + "</col>" + " " + 'x'
														+ class311.formatItemStacks(var10.itemQuantity);
											}
										}
										...
										var40.drawLines(var42, var12, var13, var10.width, var10.height, var20,
									...
									if (var10.type == 5) {
										...
										if (!var10.isIf3) {
											...
											if (var10.itemId != -1) {
												var38 = class293.getItemSprite(var10.itemId, var10.itemQuantity,
											...
											if (var38 == null) {
												...
												if (!var10.spriteTiling) {
													...
													if (var10.spriteAngle != 0) {
														var38.method2552(var10.width / 2 + var12,
													...
													for (var24 = 0; var24 < var22; ++var24) {
														for (var25 = 0; var25 < var23; ++var25) {
															if (var10.spriteAngle != 0) {
																var38.method2552(var20 / 2 + var12 + var24 * var20,
																		var21 / 2 + var13 + var25 * var21,
																		var10.spriteAngle, 4096);
															} else if (var14 != 0) {
																var38.drawTransAt(var12 + var20 * var24,
																		var13 + var21 * var25, 256 - (var14 & 255));
															} else {
										...
										if (var10.type == 6) {
											...
											var22 = 0;
											if (var10.itemId != -1) {
												ItemComposition var44 = ParamComposition
														.ItemDefinition_get(var10.itemId);
												if (var44 != null) {
												...
												var39 = var10.getModel(var33, var34, var36,
														BuddyRankComparator.localPlayer.appearance, var45, var32);
											...
											if (var39 != null) {
												if (!var10.isIf3) {
													var39.method1288(0, var10.modelAngleY, 0, var10.modelAngleX, 0,
															var23, var24);
												} else {
													var39.calculateBoundsCylinder();
													if (var10.modelOrthog) {
														var39.method1286(0, var10.modelAngleY, var10.modelAngleZ,
																var10.modelAngleX, var10.modelOffsetX,
																var23 + var22 + var10.modelOffsetY,
																var24 + var10.modelOffsetY, var10.modelZoom);
													} else {
														var39.method1288(0, var10.modelAngleY, var10.modelAngleZ,
																var10.modelAngleX, var10.modelOffsetX,
																var23 + var22 + var10.modelOffsetY,
											...
											Font var29;
											if (var10.type == 8 && var10 == Script.field803
													&& Client.field410 == Client.field424) {
												var19 = 0;
												var20 = 0;
												...
												String var31;
												for (var30 = Player.method497(var30, var10); var30
												...
												for (var30 = Player.method497(var30, var10); var30
														.length() > 0; var34 = var34 + var29.ascent + 1) {
											...
											if (var10.type == 9) {
												...
												if (var10.lineWid == 1) {
													...
													WorldMapIcon_1.method1319(var19, var20, var21, var22, var10.color,
															var10.lineWid);
												}
												...
												if (var37 != null && var35 != null && var37.method1694()) {
													var29 = var10.getFont();
													if (var29 != null) {
														Client.field561.method2562(var12, var13, var10.width,
																var10.height, var37.method1695(), var37.method1722(),
																var37.method1693(), var37.method1729(),
																var37.method1692());
														var22 = var10.textShadowed
																? var10.spriteShadow * -550984701 * -271178069
																: -1;
														if (!var37.method1721() && var37.method1688().method1949()) {
															Client.field561.method2560(var35.field2771, var22,
																	var35.field2768, var35.field2769);
															Client.field561.method2561(var37.method1689(), var29);
														} else {
															Client.field561.method2560(var10.color, var22,
																	var35.field2768, var35.field2769);
