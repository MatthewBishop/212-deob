public class MidiPcmStream extends PcmStream {
		...
		if (var9 != null) {
			...
			if (var8 != null) {
				...
				if (this.field2700[var1] == 0) {
					var6.stream = RawPcmStream.method239(var8, this.method1578(var6), this.method1579(var6),
							this.method1580(var6));
				} else {
	...
	int method1578(MusicPatchNode var1) {
		...
		var4 = (int) ((double) (var1.rawSound.sampleRate * 256) * Math.pow(2.0D, (double) var2 * 3.255208333333333E-4D)
				/ (double) PcmPlayer.field194 + 0.5D);
	...
	int method1579(MusicPatchNode var1) {
		...
		if (var2.field2665 > 0) {
			var3 = (int) ((double) var3
					* Math.pow(0.5D, (double) var2.field2665 * 1.953125E-5D * (double) var1.field2740) + 0.5D);
		}
	...
	int method1580(MusicPatchNode var1) {
		...
		return var2 < 8192 ? var2 * var1.field2741 + 32 >> 6
				: 16384 - ((128 - var1.field2741) * (16384 - var2) + 32 >> 6);
	}
	...
	boolean method1587(MusicPatchNode var1, int[] var2, int var3, int var4) {
		...
		if (var1.field2751 < 0 || var1.stream != null && !var1.stream.method269()) {
			...
			if (var5 > 0) {
				var5 -= (int) (16.0D * Math.pow(2.0D, 4.921259842519685E-4D * (double) this.field2685[var1.field2755])
						+ 0.5D);
				if (var5 < 0) {
					var5 = 0;
				}
			...
			double var8 = 5.086263020833333E-6D
					* (double) ((var1.field2739 - 60 << 8) + (var1.field2743 * var1.field2744 >> 12));
			if (var6.field2665 > 0) {
				if (var6.field2668 > 0) {
			...
			if (var6.field2669 != null) {
				...
				while (var1.field2747 < var6.field2669.length - 2
						&& var1.field2746 > (var6.field2669[var1.field2747 + 2] & 255) << 8) {
					var1.field2747 += 2;
				}
			...
			if (var1.field2751 >= 0 && var6.field2664 != null && (this.field2697[var1.field2755] & 1) == 0
					&& (var1.field2734 < 0 || var1 != this.field2696[var1.field2755][var1.field2734])) {
				if (var6.field2671 > 0) {
				...
				while (var1.field2749 < var6.field2664.length - 2
						&& var1.field2751 > (var6.field2664[var1.field2749 + 2] & 255) << 8) {
					var1.field2749 += 2;
				}
