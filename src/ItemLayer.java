public final class ItemLayer {
	...
	static final int method1120(int var0, int var1) {
		int var2 = Varcs.method617(var0 + '넵', var1 + 91923, 4) - 128
				+ (Varcs.method617(var0 + 10294, var1 + '鎽', 2) - 128 >> 1)
				+ (Varcs.method617(var0, var1, 1) - 128 >> 2);
	...
	static int method1119(int var0, Script var1, boolean var2) {
		...
		if (var0 == 4200) {
			...
			Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize - 1] = ParamComposition
			...
			if (var0 == 4201) {
				...
				var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = ParamComposition
						.ItemDefinition_get(var3).price;
				return 1;
			} else if (var0 == 4204) {
				var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
						- 1] = ParamComposition.ItemDefinition_get(var3).isStackable == 1 ? 1 : 0;
				return 1;
			} else {
				...
				if (var0 == 4205) {
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ParamComposition.ItemDefinition_get(var3).isMembersOnly ? 1 : 0;
					return 1;
				} else if (var0 == 4208) {
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					var6 = ParamComposition.ItemDefinition_get(var3);
					...
					if (GrandExchangeEvents.foundItemIds != null
							&& class173.foundItemIndex < class323.foundItemIdCount) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = GrandExchangeEvents.foundItemIds[++class173.foundItemIndex - 1] & '\uffff';
					} else {
