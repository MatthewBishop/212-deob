...
public enum class87 implements class352 {
	...
	public static void method475(String var0, String var1, int var2, int var3) throws IOException {
		...
		class164.cacheParentPaths = new String[] { "c:/rscache/", "/rscache/", "c:/windows/", "c:/winnt/", "c:/",
				class16.userHomeDirectory, "/tmp/", "" };
		StudioGame.cacheSubPaths = new String[] { ".jagex_cache_" + class7.cacheGamebuild,
				".file_store_" + class7.cacheGamebuild };
		int var18 = 0;

		label263: while (var18 < 4) {
			String var6 = var18 == 0 ? "" : "" + var18;
			ClanChannelMember.JagexCache_locationFile = new File(class16.userHomeDirectory,
			...
			if (var7 == null && var18 == 0) {
				label238: for (int var20 = 0; var20 < StudioGame.cacheSubPaths.length; ++var20) {
					for (int var21 = 0; var21 < class164.cacheParentPaths.length; ++var21) {
						File var22 = new File(class164.cacheParentPaths[var21] + StudioGame.cacheSubPaths[var20]
			...
			if (var7 == null) {
				var7 = class16.userHomeDirectory + File.separatorChar + "jagexcache" + var6 + File.separatorChar + var0
		...
		JagexCache.JagexCache_dat2File = new BufferedFile(
				new AccessFile(class126.getFile("main_file_cache.dat2"), "rw", 1048576000L), 5200, 0);
		JagexCache.JagexCache_idx255File = new BufferedFile(
				new AccessFile(class126.getFile("main_file_cache.idx255"), "rw", 1048576L), 6000, 0);
		JagexCache.JagexCache_idxFiles = new BufferedFile[class188.idxCount];

		for (var18 = 0; var18 < class188.idxCount; ++var18) {
			JagexCache.JagexCache_idxFiles[var18] = new BufferedFile(
					new AccessFile(class126.getFile("main_file_cache.idx" + var18), "rw", 1048576L), 6000, 0);
		}
