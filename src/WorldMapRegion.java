...
public class WorldMapRegion {
	...
	void addAllToIconList(List var1) {
		...
		while (var2.hasNext()) {
			...
			if (class123.WorldMapElement_get(var3.element).field1478 && var3.coord2.x >> 6 == this.regionX
					&& var3.coord2.y >> 6 == this.regionY) {
				WorldMapIcon_0 var4 = new WorldMapIcon_0(var3.coord2, var3.coord2, var3.element,
						this.method1390(var3.element));
	...
	void drawTileGround(int var1, int var2, AbstractWorldMapData var3, WorldMapScaleHandler var4, WorldMapSprite var5) {
		...
		if (var7 != -1) {
			...
			if (var11 == null) {
				...
				if (var11.secondaryRgb >= 0) {
					...
					var12 = WorldMapLabelSize.method1318(
							Rasterizer3D.Rasterizer3D_textureLoader.getAverageTextureRGB(var11.texture), 96);
		...
		if (var7 > -1 && var3.field2347[0][var1][var2] == 0) {
			...
			if (var7 == -1) {
				...
				var4.method1508(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), var9, var8,
						this.pixelsPerTile, this.pixelsPerTile, var3.field2347[0][var1][var2],
						var3.field2350[0][var1][var2]);
			}
		}
	}
			...
			if (var6 > -1) {
				...
				if (var9 == null) {
					...
					if (var9.secondaryRgb >= 0) {
						var10 = class156.method829(var9.secondaryHue, var9.secondarySaturation,
								var9.secondaryLightness);
						...
						var10 = WorldMapLabelSize.method1318(
								Rasterizer3D.Rasterizer3D_textureLoader.getAverageTextureRGB(var9.texture), 96);
				...
				if (var3.field2347[var5][var1][var2] == 0) {
					...
					var4.method1508(this.pixelsPerTile * var1, this.pixelsPerTile * (63 - var2), 0, var7,
							this.pixelsPerTile, this.pixelsPerTile, var3.field2347[var5][var1][var2],
							var3.field2350[var5][var1][var2]);
				}
			}
		}
				...
				for (int var8 = 0; var8 < var7.length; ++var8) {
					...
					if (var12.mapSceneId != -1) {
						if (var12.mapSceneId != 46 && var12.mapSceneId != 52) {
							var4[var12.mapSceneId].method2519(this.pixelsPerTile * var1,
									this.pixelsPerTile * (63 - var2), this.pixelsPerTile * 2, this.pixelsPerTile * 2);
						} else {
							var4[var12.mapSceneId].method2519(this.pixelsPerTile * var1,
		...
		if (var6 != null) {
			if (var6.size.method1314(var5)) {
				...
				var7.drawLines(var6.text, var3 - var6.width / 2, var4, var6.width, var6.height,
						-16777216 | var2.field1468, 0, 1, 0, var7.ascent / 2);
			}
		}
	}
