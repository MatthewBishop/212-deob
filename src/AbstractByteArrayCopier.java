	...
	static final void drawMinimap(Widget var0, int var1, int var2, int var3) {
		...
		if (var4 != null) {
			...
			if (Client.minimapState != 2 && Client.minimapState != 5) {
				...
				class188.sceneMinimapSprite.drawRotatedMaskedCenteredAround(var1, var2, var4.width, var4.height, var6,
				...
				for (var10 = 0; var10 < var8; ++var10) {
					...
					if (var16 != null && var16.isVisible() && !var16.isHidden
							&& var16 != BuddyRankComparator.localPlayer) {
						...
						} else if (BuddyRankComparator.localPlayer.team != 0 && var16.team != 0
								&& var16.team == BuddyRankComparator.localPlayer.team) {
				...
				if (Client.hintArrowType != 0 && Client.cycle % 20 < 10) {
					if (Client.hintArrowType == 1 && Client.hintArrowNpcIndex >= 0
						...
						if (var19 != null) {
							...
							Frames.worldToMinimap(var1, var2, var11, var12, AbstractWorldMapData.mapMarkerSprites[1],
									var4);
						}
					}

					if (Client.hintArrowType == 2) {
						var10 = Client.hintArrowX * 4 - GameEngine.baseX * 4 + 2
								- BuddyRankComparator.localPlayer.x / 32;
				...
				if (Client.destinationX != 0) {
					...
					class149.drawSpriteOnMinimap(var1, var2, var10, var11, AbstractWorldMapData.mapMarkerSprites[0],
							var4);
				}
