...
public class Messages {
	...
	static int method620(int var0, Script var1, boolean var2) {
		if (var0 == 3200) {
			...
			Skills.queueSoundEffect(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
			...
			class19.playJingle(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
					Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
			return 1;
		} else {
			int var6;
