...
public class class159 extends class140 {
		...
		if (var0 != 7500 && var0 != 7508) {
			if (var0 != 7501) {
					...
					if (var8 >= 0) {
						if (var8 >= var13) {
							throw new RuntimeException(
									"Tuple index out-of-bounds. Requested: " + var8 + ", Max: " + var13);
						}
						...
						for (var15 = var12; var15 < var13; ++var15) {
							...
							if (var17 == class467.field3949) {
								...
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
										- 1] = ItemComposition.method1053(var16);
							}
						}
							...
							for (var16 = var12; var16 < var13; ++var16) {
								...
								if (var18 == class467.field3949) {
									Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
											- 1] = (String) var14[var19];
								} else {
									Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
											- 1] = (Integer) var14[var19];
								}
							}
				...
				if (ScriptFrame.field339 != null && ScriptFrame.field339.hasNext()) {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = (Integer) ScriptFrame.field339.next();
				} else {
	...
	static final void changeGameOptions(int var0) {
		...
		if (var1 != 0) {
			...
			AttackOption[] var3;
			if (var1 == 18) {
				var3 = new AttackOption[] { AttackOption.field1071, AttackOption.AttackOption_hidden,
						AttackOption.AttackOption_alwaysRightClick, AttackOption.AttackOption_dependsOnCombatLevels,
						AttackOption.field1069 };
