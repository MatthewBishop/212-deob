				...
				if (var5 != 10 && var5 != 11) {
					if (var5 >= 12) {
						...
						var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var22, (Renderable) null,
								Tiles.field824[var4], 0, var19, var21);
						if (var4 == 0) {
							if (var8.clipped) {
						...
						var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var22, (Renderable) null,
								Tiles.field832[var4], 0, var19, var21);
						if (var8.clipped) {
							if (var4 == 0) {
								Decimator.field300[var0][var1][var2 + 1] = 50;
							} else if (var4 == 1) {
						...
						if (var5 == 2) {
							...
							var6.newBoundaryObject(var0, var1, var2, var16, (Renderable) var23, (Renderable) var24,
									Tiles.field824[var4], Tiles.field824[var28], var19, var21);
							if (var8.modelClipped) {
								if (var4 == 0) {
									class17.field51[var0][var1][var2] |= 585;
									class17.field51[var0][var1][var2 + 1] |= 1170;
							...
							var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var22, (Renderable) null,
									Tiles.field824[var4], 0, 0, 0, var19, var21);
						} else {
							Object var25;
							long var29;
							if (var5 == 5) {
								...
								var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var25, (Renderable) null,
										Tiles.field824[var4], 0, var28 * Tiles.field826[var4],
										var28 * Tiles.field828[var4], var19, var21);
							} else if (var5 == 6) {
								var28 = 8;
								var29 = var6.getBoundaryObjectTag(var0, var1, var2);
								if (0L != var29) {
								...
								var6.newWallDecoration(var0, var1, var2, var16, (Renderable) var25, (Renderable) null,
										256, var4, var28 * Tiles.field829[var4], var28 * Tiles.field830[var4], var19,
										var21);
							} else if (var5 == 7) {
								var31 = var4 + 2 & 3;
								if (var8.animationId == -1 && var8.transforms == null) {
					...
					if (var22 != null && var6.method1240(var0, var1, var2, var16, var9, var10, (Renderable) var22,
