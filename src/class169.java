public class class169 {
	...
	static final void updateInterface(Widget[] var0, int var1, int var2, int var3, int var4, int var5, int var6,
		...
		for (int var8 = 0; var8 < var0.length; ++var8) {
			...
			if (var9 != null && var9.parentId == var1 && (var9.method1745()
					|| ParamComposition.getWidgetFlags(var9) != 0 || var9 == Client.clickedWidgetParent)) {
				if (var9.isIf3) {
					if (WallDecoration.isComponentHidden(var9)) {
						continue;
					}
				} else if (var9.type == 0 && var9 != InvDefinition.mousedOverWidgetIf1
						&& WallDecoration.isComponentHidden(var9)) {
					continue;
				}
				...
				if (var34 || !var9.isIf3 || var12 < var14 && var13 < var15) {
					...
					if (var9.contentType == 1337) {
						...
						if (var9.contentType == 1400) {
							WorldMapData_1.worldMap.onCycle(MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y,
									var35, var26, var11, var9.width, var9.height);
						}

						if (!Client.isMenuOpen && var35) {
							if (var9.contentType == 1400) {
								WorldMapData_1.worldMap.addElementMenuOptions(var26, var11, var9.width, var9.height,
										var17, var18);
							} else {
						...
						if (var34) {
							for (int var20 = 0; var20 < var9.field2885.length; ++var20) {
								...
								if (!var21 && var9.field2885[var20] != null) {
									for (var23 = 0; var23 < var9.field2885[var20].length; ++var23) {
										...
										if (var9.field2976 != null) {
											var24 = Client.keyHandlerInstance
													.getKeyPressed(var9.field2885[var20][var23]);
										}
										...
										if (class150.method788(var9.field2885[var20][var23]) || var24) {
											...
											if (var25 == 0 || ((var25 & 8) == 0
													|| !Client.keyHandlerInstance.getKeyPressed(86)
															&& !Client.keyHandlerInstance.getKeyPressed(82)
															&& !Client.keyHandlerInstance.getKeyPressed(81))
													&& ((var25 & 2) == 0 || Client.keyHandlerInstance.getKeyPressed(86))
													&& ((var25 & 1) == 0 || Client.keyHandlerInstance.getKeyPressed(82))
													&& ((var25 & 4) == 0
															|| Client.keyHandlerInstance.getKeyPressed(81))) {
												var22 = true;
												break;
								...
								if (var22) {
									if (var20 < 10) {
										class333.widgetDefaultMenuAction(var20 + 1, var9.id, var9.childIndex,
												var9.itemId, "");
									} else if (var20 == 10) {
										GameEngine.Widget_runOnTargetLeave();
										TaskHandler.selectSpell(
												var9.id, var9.childIndex, WorldMapDecorationType
														.Widget_unpackTargetMask(ParamComposition.getWidgetFlags(var9)),
												var9.itemId);
						...
						if (var9.isIf3) {
							...
							if ((MouseHandler.MouseHandler_currentButton == 1
									|| !class319.mouseCam && MouseHandler.MouseHandler_currentButton == 4) && var35) {
								var36 = true;
							}
							...
							if (var21) {
								AbstractWorldMapData.clickWidget(var9, MouseHandler.MouseHandler_lastPressedX - var26,
										MouseHandler.MouseHandler_lastPressedY - var11);
							}

							if (var9.method1746()) {
								if (var21) {
									Client.field565.addFirst(new class207(0, MouseHandler.MouseHandler_x - var26,
											MouseHandler.MouseHandler_y - var11, var9));
								}

								if (var36) {
									Client.field565.addFirst(new class207(1, MouseHandler.MouseHandler_x - var26,
											MouseHandler.MouseHandler_y - var11, var9));
								}
							}
							...
							if (Client.clickedWidget != null && var9 != Client.clickedWidget && var35
									&& ZoneOperation.method1542(ParamComposition.getWidgetFlags(var9))) {
							...
							if (var9.hasListener) {
								...
								if (var9.onVarTransmit != null && Client.changedVarpCount > var9.field2857) {
									if (var9.varTransmitTriggers != null
											&& Client.changedVarpCount - var9.field2857 <= 32) {
										label647: for (var37 = var9.field2857; var37 < Client.changedVarpCount; ++var37) {
								...
								if (var9.onInvTransmit != null && Client.changedItemContainersCount > var9.field2972) {
									if (var9.invTransmitTriggers != null
											&& Client.changedItemContainersCount - var9.field2972 <= 32) {
										label623: for (var37 = var9.field2972; var37 < Client.changedItemContainersCount; ++var37) {
								...
								if (var9.onStatTransmit != null && Client.changedSkillsCount > var9.field2904) {
									if (var9.statTransmitTriggers != null
											&& Client.changedSkillsCount - var9.field2904 <= 32) {
										label599: for (var37 = var9.field2904; var37 < Client.changedSkillsCount; ++var37) {
						...
						if (!var9.isIf3) {
							...
							if (var9.scrollHeight > var9.height) {
								InterfaceParent.method463(var9, var26 + var9.width, var11, var9.height,
										var9.scrollHeight, MouseHandler.MouseHandler_x, MouseHandler.MouseHandler_y);
							}
						}
						...
						if (var9.type == 0) {
							...
							if (var32 != null) {
								if (var32.type == 0 && MouseHandler.MouseHandler_x >= var12
										&& MouseHandler.MouseHandler_y >= var13 && MouseHandler.MouseHandler_x < var14
										&& MouseHandler.MouseHandler_y < var15 && !Client.isMenuOpen) {
									for (ScriptEvent var33 = (ScriptEvent) Client.scriptEvents
											.last(); var33 != null; var33 = (ScriptEvent) Client.scriptEvents
													.previous()) {
										if (var33.field848) {
											var33.remove();
								...
								AbstractWorldMapData.updateRootInterface(var32.group, var12, var13, var14, var15, var26,
										var11);
							}
						}
					}
