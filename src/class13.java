...
class class13 extends DefaultTlsClient {
	...
	static final void method46(Actor var0) {
					...
					if (var0.movementFrame >= var1.frameIds.length) {
						if (var1.frameCount > 0) {
							...
							if (var0.movementFrame < 0 || var0.movementFrame >= var1.frameIds.length
									|| var1.field1798 && var0.field970 >= var1.iterations) {
		...
		if (var0.spotAnimation != -1 && Client.cycle >= var0.spotAnimationStartCycle) {
			...
			if (var4 != -1) {
				...
				if (var5 != null && var5.frameIds != null && !var5.isCachedModelIdSet()) {
					++var0.field964;
					if (var0.spotAnimationFrame < var5.frameIds.length
							&& var0.field964 > var5.frameLengths[var0.spotAnimationFrame]) {
						var0.field964 = 1;
					...
					if (var0.spotAnimationFrame >= var5.frameIds.length
							&& (var0.spotAnimationFrame < 0 || var0.spotAnimationFrame >= var5.frameIds.length)) {
		...
		if (var0.sequence != -1 && var0.sequenceDelay <= 1) {
			...
			if (var1.precedenceAnimating == 1 && var0.field1004 > 0 && var0.exactMoveArrive1Cycle <= Client.cycle
					&& var0.exactMoveArrive2Cycle < Client.cycle) {
			...
			if (var1 != null) {
				if (!var1.isCachedModelIdSet() && var1.frameIds != null) {
					...
					if (var0.sequenceFrame < var1.frameIds.length
							&& var0.sequenceFrameCycle > var1.frameLengths[var0.sequenceFrame]) {
