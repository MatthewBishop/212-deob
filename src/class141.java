	...
	static void drawTitle(Font var0, Font var1, Font var2) {
		...
		if (Login.worldSelectOpen) {
			...
			if (class12.worldSelectLeftSprite == null) {
				class12.worldSelectLeftSprite = class368.SpriteBuffer_getIndexedSpriteByName(class143.archive8,
						"leftarrow", "");
			}

			if (class208.worldSelectRightSprite == null) {
				class208.worldSelectRightSprite = class368.SpriteBuffer_getIndexedSpriteByName(class143.archive8,
						"rightarrow", "");
			}
			...
			if (WorldMapSection2.worldSelectBackSprites != null) {
				...
				if (class12.worldSelectLeftSprite != null && Login.worldSelectPage > 0) {
					class12.worldSelectLeftSprite.drawAt(8,
							class143.canvasHeight / 2 - class12.worldSelectLeftSprite.subHeight / 2);
				}

				if (class208.worldSelectRightSprite != null && Login.worldSelectPage < Login.worldSelectPagesCount) {
					class208.worldSelectRightSprite.drawAt(
							GameEngine.canvasWidth - class208.worldSelectRightSprite.subWidth - 8,
							class143.canvasHeight / 2 - class208.worldSelectRightSprite.subHeight / 2);
				}
				...
				int var48;
				for (var48 = var6 * var47; var48 < World.World_count
						&& var47 - Login.worldSelectPage < var38; ++var48) {
					...
					if (MouseHandler.MouseHandler_x >= var45 && MouseHandler.MouseHandler_y >= var12
							&& MouseHandler.MouseHandler_x < var45 + var23
							&& MouseHandler.MouseHandler_y < var12 + var56 && var49) {
					...
					if (class279.worldSelectFlagSprites != null) {
						class279.worldSelectFlagSprites[(var18.isMembersOnly() ? 8 : 0) + var18.location]
								.drawAt(var45 + 29, var12);
					}
				...
				if (var15) {
					...
					Rasterizer2D.Rasterizer2D_fillRectangle(MouseHandler.MouseHandler_x - var48 / 2, var50, var48,
							var25, 16777120);
					Rasterizer2D.Rasterizer2D_drawRectangle(MouseHandler.MouseHandler_x - var48 / 2, var50, var48,
							var25, 0);
					var1.drawCentered(class260.World_worlds[Login.hoveredWorldIndex].activity,
							MouseHandler.MouseHandler_x, var50 + var1.ascent + 4, 0, -1);
				}
			}
			...
			if (Client.gameState == 0 || Client.gameState == 5) {
				var23 = 20;
				var0.drawCentered("RuneScape is loading - please wait...", Login.loginBoxX + 180, 245 - var23, 16777215,
						-1);
				var24 = 253 - var23;
				...
				Rasterizer2D.Rasterizer2D_fillRectangle(Login.loginBoxX + 180 - 150, var24 + 2,
				...
				Rasterizer2D.Rasterizer2D_fillRectangle(Login.Login_loadingPercent * 3 + (Login.loginBoxX + 180 - 150),
						var24 + 2, 300 - Login.Login_loadingPercent * 3, 30, 0);
			...
			if (Client.gameState == 20) {
				WorldMapSprite.titleboxSprite.drawAt(Login.loginBoxX + 180 - WorldMapSprite.titleboxSprite.subWidth / 2,
						271 - WorldMapSprite.titleboxSprite.subHeight / 2);
				var51 = 201;
				...
				if (Login.loginIndex != 4 && Login.loginIndex != 10) {
					...
					for (var26 = UserComparator3.method661(); var0.stringWidth(var26) > var53; var26 = var26
							.substring(0, var26.length() - 1)) {
						;
					}
			...
			if (Client.gameState == 10 || Client.gameState == 11 || Client.gameState == 50) {
				...
				if (Login.loginIndex == 0) {
					...
					if (Login.loginIndex == 2) {
						...
						var0.draw(AbstractFont.escapeBrackets(var30)
								+ (Login.currentLoginField == 0 & Client.cycle % 40 < 20
										? Canvas.colorStartTag(16776960) + "|"
										: ""),
								Login.loginBoxCenter - 70, var52, 16777215, 0);
						var52 += 15;
						...
						var0.draw("Password: " + var32
								+ (Login.currentLoginField == 1 & Client.cycle % 40 < 20
										? Canvas.colorStartTag(16776960) + "|"
										: ""),
								Login.loginBoxCenter - 108, var52, 16777215, 0);
						var52 += 15;
						var51 = 277;
						var10 = Login.loginBoxCenter + -117;
						boolean var44 = Client.Login_isUsernameRemembered;
						boolean var13 = Login.field737;
						IndexedSprite var55 = var44 ? (var13 ? KitDefinition.field1507 : Login.options_buttons_2Sprite)
								: (var13 ? ArchiveLoader.field836 : Login.options_buttons_0Sprite);
						...
						IndexedSprite var34 = var16 ? (var17 ? KitDefinition.field1507 : Login.options_buttons_2Sprite)
								: (var17 ? ArchiveLoader.field836 : Login.options_buttons_0Sprite);
						...
						WorldMapSectionType.field2332 = new Bounds(Login.loginBoxCenter, var51,
								var1.stringWidth(InvDefinition.field1458), 11);
						DevicePcmPlayerProvider.field67 = new Bounds(Login.loginBoxCenter, var51,
						...
						var52 = var51 + 20;
						var1.drawCentered("You may need to use the Jagex Launcher to continue playing.",
								Login.loginBoxX + 180, var52, 16776960, 0);
						var52 += 20;
						var1.drawCentered("<col=ffd200>Download it here.</col>", Login.loginBoxX + 180, var52, 16776960,
								0);
						var52 += 15;
						...
						var29 = new String(var28);
						var0.draw(var26 + var29 + (Client.cycle % 40 < 20 ? Canvas.colorStartTag(16776960) + "|" : ""),
								Login.loginBoxX + 180 - 108, var52, 16777215, 0);
						var52 -= 8;
						...
						var0.draw(
								AbstractFont.escapeBrackets(var26)
										+ (Client.cycle % 40 < 20 ? Canvas.colorStartTag(16776960) + "|" : ""),
								Login.loginBoxX + 180 - 34, var52, 16777215, 0);
						var52 += 15;
						...
						if (class157.field1372 && !Client.onMobile) {
							...
							for (var38 = 0; var38 < 8; ++var38) {
								...
								var0.draw(
										(Login.field745[var38] == null ? "" : Login.field745[var38])
												+ (var37 ? Canvas.colorStartTag(16776960) + "|" : ""),
										var24 + 10, var52 + 27, 16777215, 0);
								if (var38 != 1 && var38 != 3) {
									var24 += 35;
								} else {
									var24 += 50;
							...
							var51 = 216;
							var0.drawCentered("Your date of birth isn't set.", Login.loginBoxX + 180, var51, 16776960,
									0);
							var52 = var51 + 15;
							var2.drawCentered("Please verify your account status by", Login.loginBoxX + 180, var52,
									16776960, 0);
							var52 += 15;
						...
						var51 = 216;
						var0.drawCentered("Sorry, but your account is not eligible to play.", Login.loginBoxX + 180,
								var51, 16776960, 0);
						var52 = var51 + 15;
						var2.drawCentered("For more information, please take a look at", Login.loginBoxX + 180, var52,
								16776960, 0);
						var52 += 15;
						...
						var53 = 216;
						var2.drawCentered("Before using this app, please read and accept our", var52, var53, 16777215,
								0);
						var24 = var53 + 17;
						var2.drawCentered(
								"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
								var52, var24, 16777215, 0);
						var24 += 17;
						...
						var51 = 231;
						var2.drawCentered("You must accept our terms of use, privacy policy,", Login.loginBoxX + 180,
								var51, 16777215, 0);
						var52 = var51 + 20;
						var2.drawCentered("and end user licence agreement to continue.", Login.loginBoxX + 180, var52,
								16777215, 0);
						var24 = Login.loginBoxX + 180;
						var51 = 311;
			...
			class139.title_muteSprite[WorldMapSectionType.clientPreferences.getTitleMusicDisabled() ? 1 : 0]
			...
			if (Client.gameState > 5 && Language.Language_EN == class69.clientLanguage) {
				if (FriendSystem.field664 != null) {
					...
					var0.drawCentered("World" + " " + Client.worldId, var43 / 2 + var52, var40 / 2 + var53 - 2,
							16777215, 0);
