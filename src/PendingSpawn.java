public final class PendingSpawn extends Node {
					...
					do {
						do {
							label242: do {
								...
								if (var18 > 0 && class212.directions[var18 - 1][var19] == 0
								...
								if (var18 < 128 - var2 && class212.directions[var18 + 1][var19] == 0
								...
								if (var19 > 0 && class212.directions[var18][var19 - 1] == 0
								...
								if (var19 < 128 - var2 && class212.directions[var18][var19 + 1] == 0
								...
								if (var18 > 0 && var19 > 0 && class212.directions[var18 - 1][var19 - 1] == 0
								...
								if (var18 < 128 - var2 && var19 > 0 && class212.directions[var18 + 1][var19 - 1] == 0
								...
								if (var18 > 0 && var19 < 128 - var2 && class212.directions[var18 - 1][var19 + 1] == 0
	...
	static final void method502(int var0, int var1, int var2) {
		if (class381.cameraX < var0) {
			class381.cameraX = (var0 - class381.cameraX) * class313.cameraMoveToAcceleration / 1000 + class381.cameraX
					+ class19.cameraMoveToSpeed;
			if (class381.cameraX > var0) {
		...
		if (class381.cameraX > var0) {
			class381.cameraX -= (class381.cameraX - var0) * class313.cameraMoveToAcceleration / 1000
					+ class19.cameraMoveToSpeed;
			if (class381.cameraX < var0) {
				class381.cameraX = var0;
			}
		...
		if (class351.cameraY < var1) {
			class351.cameraY = (var1 - class351.cameraY) * class313.cameraMoveToAcceleration / 1000 + class351.cameraY
					+ class19.cameraMoveToSpeed;
			if (class351.cameraY > var1) {
		...
		if (class351.cameraY > var1) {
			class351.cameraY -= (class351.cameraY - var1) * class313.cameraMoveToAcceleration / 1000
					+ class19.cameraMoveToSpeed;
			if (class351.cameraY < var1) {
				class351.cameraY = var1;
			}
		...
		if (class471.cameraZ < var2) {
			class471.cameraZ = (var2 - class471.cameraZ) * class313.cameraMoveToAcceleration / 1000 + class471.cameraZ
					+ class19.cameraMoveToSpeed;
			if (class471.cameraZ > var2) {
		...
		if (class471.cameraZ > var2) {
			class471.cameraZ -= (class471.cameraZ - var2) * class313.cameraMoveToAcceleration / 1000
					+ class19.cameraMoveToSpeed;
			if (class471.cameraZ < var2) {
				class471.cameraZ = var2;
			}
