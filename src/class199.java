	...
	static final void method1003(int var0, int var1) {
		if (Client.currentClanChannels[var0] != null) {
			if (var1 >= 0 && var1 < Client.currentClanChannels[var0].method843()) {
				...
				if (var2.rank == -1) {
					PacketBufferNode var3 = UserComparator9.getPacketBufferNode(ClientPacket.field2508,
							Client.packetWriter.isaacCipher);
					var3.packetBuffer
							.writeByte(3 + WorldMapLabel.stringCp1252NullTerminatedByteSize(var2.username.getName()));
