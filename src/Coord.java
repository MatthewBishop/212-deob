public class Coord {
	...
	static final void method1633(int var0, int var1) {
		if (Client.hintArrowType == 2) {
			GrandExchangeOfferUnitPriceComparator.worldToScreen(
					(Client.hintArrowX - GameEngine.baseX << 7) + Client.hintArrowSubX,
					(Client.hintArrowY - class178.baseY << 7) + Client.hintArrowSubY, Client.hintArrowHeight * 2);
			if (Client.viewportTempX > -1 && Client.cycle % 20 < 10) {
				EnumComposition.headIconHintSprites[0].drawTransBgAt(var0 + Client.viewportTempX - 12,
