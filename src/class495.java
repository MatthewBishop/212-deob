public class class495 {
	...
	public void method2562(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			boolean var9) {
		this.field4070 = var1;
		this.field4071 = var2;
		this.field4072 = var3;
	...
	public void method2561(class375 var1, Font var2) {
		if (var2 != null) {
			...
			Rasterizer2D.Rasterizer2D_setClip(this.field4070, this.field4071, this.field4072 + this.field4070,
					this.field4073 + this.field4071);
