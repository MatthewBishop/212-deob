		...
		if (var0 == 3600) {
			if (class6.friendSystem.field662 == 0) {
				...
				Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
						- 1] = class6.friendSystem.friendsList.getSize();
			}
			...
			if (var0 == 3601) {
				...
				if (class6.friendSystem.method408() && var3 >= 0 && var3 < class6.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ((Buddy) class6.friendSystem.friendsList.get(var3)).world;
				} else {
				...
				if (class6.friendSystem.method408() && var3 >= 0 && var3 < class6.friendSystem.friendsList.getSize()) {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ((Buddy) class6.friendSystem.friendsList.get(var3)).rank;
				} else {
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
				}
				...
				if (var0 == 3604) {
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class6.friendSystem
							.isFriended(new Username(var5, Occluder.loginType), false) ? 1 : 0;
					return 1;
				} else if (var0 == 3611) {
					if (ReflectionCheck.friendsChat != null) {
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
								- 1] = ReflectionCheck.friendsChat.name;
					} else {
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (ReflectionCheck.friendsChat != null) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = ReflectionCheck.friendsChat.getSize();
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (ReflectionCheck.friendsChat != null && var3 < ReflectionCheck.friendsChat.getSize()) {
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
								- 1] = ReflectionCheck.friendsChat.get(var3).getUsername().getName();
					} else {
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize - 1] = "";
					}
					...
					if (ReflectionCheck.friendsChat != null && var3 < ReflectionCheck.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = ((Buddy) ReflectionCheck.friendsChat.get(var3)).getWorld();
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (ReflectionCheck.friendsChat != null && var3 < ReflectionCheck.friendsChat.getSize()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = ((Buddy) ReflectionCheck.friendsChat.get(var3)).rank;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ReflectionCheck.friendsChat != null ? ReflectionCheck.friendsChat.minKick : 0;
					return 1;
				} else if (var0 == 3617) {
					var5 = Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize];
					...
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
							- 1] = ReflectionCheck.friendsChat != null
									? ReflectionCheck.friendsChat.rank * 1806812183 * -1348750425
									: 0;
					return 1;
				} else if (var0 == 3619) {
					var5 = Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize];
					...
					if (!class6.friendSystem.method408()) {
						...
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
								- 1] = class6.friendSystem.ignoreList.getSize();
					}

					return 1;
				} else if (var0 == 3622) {
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (class6.friendSystem.method408() && var3 >= 0
							&& var3 < class6.friendSystem.ignoreList.getSize()) {
					...
					var5 = ItemComposition.method1054(var5);
					Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class6.friendSystem
							.isIgnored(new Username(var5, Occluder.loginType)) ? 1 : 0;
					return 1;
				} else if (var0 == 3624) {
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (ReflectionCheck.friendsChat != null && var3 < ReflectionCheck.friendsChat.getSize()
							&& ReflectionCheck.friendsChat.get(var3).getUsername()
									.equals(BuddyRankComparator.localPlayer.username)) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					if (ReflectionCheck.friendsChat != null && ReflectionCheck.friendsChat.owner != null) {
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
								- 1] = ReflectionCheck.friendsChat.owner;
					} else {
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize - 1] = "";
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (ReflectionCheck.friendsChat != null && var3 < ReflectionCheck.friendsChat.getSize()
							&& ((ClanMate) ReflectionCheck.friendsChat.get(var3)).isFriend()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
					...
					var3 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
					if (ReflectionCheck.friendsChat != null && var3 < ReflectionCheck.friendsChat.getSize()
							&& ((ClanMate) ReflectionCheck.friendsChat.get(var3)).isIgnored()) {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 1;
					} else {
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
					}
