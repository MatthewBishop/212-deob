	...
	public void read(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (-1L != this.writeBufferOffset && this.offset >= this.writeBufferOffset
					&& (long) var3 + this.offset <= this.writeBufferOffset + (long) this.writeBufferLength) {
			...
			if (this.writeBufferOffset != -1L) {
				...
				if (this.writeBufferOffset >= var4 && this.writeBufferOffset < (long) var7 + var4) {
					var13 = this.writeBufferOffset;
						...
						&& var4 < (long) this.writeBufferLength + this.writeBufferOffset) {
					var13 = var4;
				}

				if (this.writeBufferOffset + (long) this.writeBufferLength > var4
					...
					var10 = this.writeBufferOffset + (long) this.writeBufferLength;
						...
						&& (long) var7 + var4 <= (long) this.writeBufferLength + this.writeBufferOffset) {
	...
	public void write(byte[] var1, int var2, int var3) throws IOException {
		try {
			...
			if (var3 <= this.writeBuffer.length) {
				...
				long var6 = -1L;
				if (this.offset >= this.readBufferOffset
						&& this.offset < this.readBufferOffset + (long) this.readBufferLength) {
					var9 = this.offset;
				} else if (this.readBufferOffset >= this.offset && this.readBufferOffset < this.offset + (long) var3) {
					var9 = this.readBufferOffset;
				}

				if (this.offset + (long) var3 > this.readBufferOffset
						&& (long) var3 + this.offset <= (long) this.readBufferLength + this.readBufferOffset) {
					var6 = (long) var3 + this.offset;
				} else if (this.readBufferOffset + (long) this.readBufferLength > this.offset
						&& this.readBufferOffset + (long) this.readBufferLength <= (long) var3 + this.offset) {
	...
	void flush() throws IOException {
		if (this.writeBufferOffset != -1L) {
			...
			if (this.writeBufferOffset >= this.readBufferOffset
					&& this.writeBufferOffset < (long) this.readBufferLength + this.readBufferOffset) {
			...
			if (this.writeBufferOffset + (long) this.writeBufferLength > this.readBufferOffset
					&& (long) this.writeBufferLength + this.writeBufferOffset <= this.readBufferOffset
							+ (long) this.readBufferLength) {
				var3 = (long) this.writeBufferLength + this.writeBufferOffset;
					...
					&& (long) this.readBufferLength + this.readBufferOffset <= this.writeBufferOffset
