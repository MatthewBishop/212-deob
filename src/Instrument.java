		...
		if (var2 < 10) {
			...
			for (var11 = 0; var11 < 5; ++var11) {
				if (this.oscillatorVolume[var11] != 0) {
					...
					Instrument_pitchSteps[var11] = (int) ((double) (this.pitch.end - this.pitch.start) * 32.768D
			...
			for (var11 = 0; var11 < var1; ++var11) {
				...
				for (var14 = 0; var14 < 5; ++var14) {
					if (this.oscillatorVolume[var14] != 0) {
						...
						if (var15 < var1) {
							Instrument_samples[var15] += this.evaluateWave(Instrument_phases[var14],
									var13 * Instrument_volumeSteps[var14] >> 15, this.pitch.form);
							Instrument_phases[var14] += (var12 * Instrument_pitchSteps[var14] >> 16)
