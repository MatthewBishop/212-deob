...
public class GrandExchangeOfferOwnWorldComparator implements Comparator {
	...
	static HorizontalAlignment[] method345() {
		return new HorizontalAlignment[] { HorizontalAlignment.field1539, HorizontalAlignment.field1537,
			...
			if (Client.titleLoadingStage == 45) {
				...
				if (Client.titleLoadingStage == 60) {
					...
					if (!class258.archive2.isFullyLoaded()) {
						...
						KitDefinition.KitDefinition_fileCount = GrandExchangeOfferTotalQuantityComparator.KitDefinition_archive
								.getGroupFileCount(3);
						...
						class123.method677(class135.archive4, Clock.archive11, class143.archive8,
								TextureProvider.archive13);
						...
						KitDefinition.HitSplatDefinition_cachedSprites = new class462(DbTableType.field3951, 54,
								class69.clientLanguage, class258.archive2);
						Messages.HitSplatDefinition_cached = new class462(DbTableType.field3951, 47,
								class69.clientLanguage, class258.archive2);
					...
					if (class149.compass == null) {
						class149.compass = WorldMapScaleHandler.SpriteBuffer_getSprite(class143.archive8,
								PcmPlayer.spriteIds.compass, 0);
					} else {
						++var30;
					}

					if (class136.redHintArrowSprite == null) {
						class136.redHintArrowSprite = WorldMapScaleHandler.SpriteBuffer_getSprite(class143.archive8,
								PcmPlayer.spriteIds.field3719, 0);
					} else {
						++var30;
					}

					if (LoginScreenAnimation.mapSceneSprites == null) {
						LoginScreenAnimation.mapSceneSprites = class456.method2330(class143.archive8,
								PcmPlayer.spriteIds.mapScenes, 0);
					} else {
						++var30;
					}

					if (class315.headIconPkSprites == null) {
						class315.headIconPkSprites = class70.method416(class143.archive8,
								PcmPlayer.spriteIds.headIconsPk, 0);
					} else {
						++var30;
					}

					if (class287.headIconPrayerSprites == null) {
						class287.headIconPrayerSprites = class70.method416(class143.archive8,
								PcmPlayer.spriteIds.field3716, 0);
					} else {
						++var30;
					}

					if (EnumComposition.headIconHintSprites == null) {
						EnumComposition.headIconHintSprites = class70.method416(class143.archive8,
								PcmPlayer.spriteIds.field3720, 0);
					} else {
						++var30;
					}

					if (AbstractWorldMapData.mapMarkerSprites == null) {
						AbstractWorldMapData.mapMarkerSprites = class70.method416(class143.archive8,
								PcmPlayer.spriteIds.field3721, 0);
					} else {
						++var30;
					}
					...
					if (AbstractWorldMapData.scrollBarSprites == null) {
						AbstractWorldMapData.scrollBarSprites = class456.method2330(class143.archive8,
								PcmPlayer.spriteIds.field3723, 0);
					} else {
						++var30;
					}

					if (class36.modIconSprites == null) {
						class36.modIconSprites = class456.method2330(class143.archive8, PcmPlayer.spriteIds.field3724,
								0);
					} else {
						++var30;
					}
					...
					if (!class20.field63.isFullyLoaded()) {
						...
						FriendSystem.textureProvider = new TextureProvider(class20.field63, class143.archive8, 20,
								WorldMapSectionType.clientPreferences.getBrightness(), Client.isLowDetail ? 64 : 128);
					...
					if (!class135.archive4.isFullyLoaded()) {
						...
						Login.Login_loadingText = "Loading interfaces - "
								+ (96 + TextureProvider.archive13.loadPercent() / 50) + "%";
						Login.Login_loadingPercent = 96;
					} else {
					...
					if (!MusicPatchNode.archive19.tryLoadGroupByName(WorldMapCacheName.field2394.name)) {
						Login.Login_loadingText = "Loading world map - "
								+ MusicPatchNode.archive19.groupLoadPercentByName(WorldMapCacheName.field2394.name) / 10
								+ "%";
					} else {
						if (WorldMapData_1.worldMap == null) {
							WorldMapData_1.worldMap = new WorldMap();
							WorldMapData_1.worldMap.init(MusicPatchNode.archive19, class376.archive18,
									class475.archive20, class7.fontBold12, Client.fontsMap,
									LoginScreenAnimation.mapSceneSprites);
						}
	...
	static final void drawWidgets(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		if (GrandExchangeEvent.loadInterface(var0)) {
			...
			Widget.drawInterface(class155.Widget_interfaceComponents[var0], -1, var1, var2, var3, var4, var5, var6,
					var7);
			if (class146.field1320 != null) {
				Widget.drawInterface(class146.field1320, -1412584499, var1, var2, var3, var4, ItemLayer.field1861,
