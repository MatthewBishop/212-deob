...
public class class16 implements ThreadFactory {
	...
	public Thread newThread(Runnable var1) {
		Thread var2 = new Thread(this.field49, var1,
				this.this$0.field40 + "-rest-request-" + this.field46.getAndIncrement(), 0L);
		var2.setDaemon(true);
		var2.setPriority(5);
		return var2;
	}

	public static int method60(int var0, int var1, int var2, RouteStrategy var3, CollisionMap var4, boolean var5,
			int[] var6, int[] var7) {
		int var9;
		...
		if (var2 == 1) {
			...
			while (true) {
				...
				if (var30 > 0 && class212.directions[var30 - 1][var31] == 0
				...
				if (var30 < 127 && class212.directions[var30 + 1][var31] == 0
				...
				if (var31 > 0 && class212.directions[var30][var31 - 1] == 0
				...
				if (var31 < 127 && class212.directions[var30][var31 + 1] == 0
				...
				if (var30 > 0 && var31 > 0 && class212.directions[var30 - 1][var31 - 1] == 0
				...
				if (var30 < 127 && var31 > 0 && class212.directions[var30 + 1][var31 - 1] == 0
						&& (var18[var19 + 1][var20 - 1] & 19136899) == 0 && (var18[var19 + 1][var20] & 19136896) == 0
						&& (var18[var19][var20 - 1] & 19136770) == 0) {
					class212.bufferX[var33] = var10 + 1;
					class212.bufferY[var33] = var11 - 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 > 0 && var31 < 127 && class212.directions[var30 - 1][var31 + 1] == 0
						&& (var18[var19 - 1][var20 + 1] & 19136824) == 0 && (var18[var19 - 1][var20] & 19136776) == 0
						&& (var18[var19][var20 + 1] & 19136800) == 0) {
					class212.bufferX[var33] = var10 - 1;
					class212.bufferY[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
				...
				if (var30 < 127 && var31 < 127 && class212.directions[var30 + 1][var31 + 1] == 0
						&& (var18[var19 + 1][var20 + 1] & 19136992) == 0 && (var18[var19 + 1][var20] & 19136896) == 0
						&& (var18[var19][var20 + 1] & 19136800) == 0) {
					class212.bufferX[var33] = var10 + 1;
					class212.bufferY[var33] = var11 + 1;
					var33 = var33 + 1 & 4095;
			...
			for (var20 = var33 - var32; var20 <= var33 + var32; ++var20) {
				for (var21 = var17 - var32; var21 <= var32 + var17; ++var21) {
					...
					if (var22 >= 0 && var23 >= 0 && var22 < 128 && var23 < 128
							&& class212.distances[var22][var23] < 100) {
						int var24 = 0;
						if (var20 < var33) {
							var24 = var33 - var20;
		...
		if (var0 == var11 && var30 == var1) {
			...
			for (var14 = var15 = class212.directions[var11 - var9][var30 - var10]; var0 != var11
					|| var30 != var1; var14 = class212.directions[var11 - var9][var30 - var10]) {
				if (var15 != var14) {
					var15 = var14;
	...
	static final void drawLoadingMessage(String var0, boolean var1) {
		if (Client.showLoadingMessages) {
			...
			Rasterizer2D.Rasterizer2D_fillRectangle(var3 - var2, var4 - var2, var5 + var2 + var2, var2 + var6 + var2,
					0);
			Rasterizer2D.Rasterizer2D_drawRectangle(var3 - var2, var4 - var2, var5 + var2 + var2, var2 + var6 + var2,
					16777215);
	...
	static void method57(class207 var0) {
		if (var0 != null && var0.field1809 != null) {
			if (var0.field1809.childIndex >= 0) {
				...
				if (var1 == null || var1.children == null || var1.children.length == 0
						|| var0.field1809.childIndex >= var1.children.length
						|| var0.field1809 != var1.children[var0.field1809.childIndex]) {
					return;
				}
			}
			...
			if (var0.field1809.type == 11 && var0.field1810 == 0) {
				if (var0.field1809.method1771(var0.field1807, var0.field1808, 0, 0)) {
					...
					case 1:
						if (UserComparator5.method658(ParamComposition.getWidgetFlags(var0.field1809))) {
							...
							if (var4 != null) {
								PacketBufferNode var2 = UserComparator9.getPacketBufferNode(ClientPacket.field2470,
				...
				if (var3 != null && var3.method1715()) {
					...
					case 0:
						...
						var3.method1680(var0.field1807, var0.field1808, Client.keyHandlerInstance.getKeyPressed(82),
		...
		if (BuddyRankComparator.localPlayer != var0) {
			if (Client.menuOptionsCount < 400) {
				...
				if (var0.skillLevel == 0) {
					var4 = var0.actions[0] + var0.username + var0.actions[1]
							+ NPC.method571(var0.combatLevel, BuddyRankComparator.localPlayer.combatLevel) + " " + " ("
							+ "level-" + var0.combatLevel + ")" + var0.actions[2];
				} else {
				...
				if (Client.isItemSelected == 1) {
					class110.insertMenuItemNoShift("Use",
							Client.field513 + " " + "->" + " " + Canvas.colorStartTag(16777215) + var4, 14, var1, var2,
							var3);
				} else if (Client.isSpellSelected) {
					if ((class90.selectedSpellFlags & 8) == 8) {
						class110.insertMenuItemNoShift(Client.field583,
								Client.field518 + " " + "->" + " " + Canvas.colorStartTag(16777215) + var4, 15, var1,
								var2, var3);
					}
				} else {
					for (var5 = 7; var5 >= 0; --var5) {
						if (Client.playerMenuActions[var5] != null) {
							...
							if (Client.playerMenuActions[var5].equalsIgnoreCase("Attack")) {
								...
								if (Client.playerAttackOption == AttackOption.AttackOption_alwaysRightClick
										|| AttackOption.AttackOption_dependsOnCombatLevels == Client.playerAttackOption
												&& var0.combatLevel > BuddyRankComparator.localPlayer.combatLevel) {
									var6 = 2000;
								}
							...
							class110.insertMenuItemNoShift(Client.playerMenuActions[var5],
									Canvas.colorStartTag(16777215) + var4, var8, var1, var2, var3);
						}
					}
				}
