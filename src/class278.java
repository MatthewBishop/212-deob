public class class278 {
	...
	static final void method1536(int var0, int var1) {
		...
		if (class311.cameraPitch < var0) {
			class311.cameraPitch = (var0 - class311.cameraPitch) * Skeleton.cameraLookAtAcceleration / 1000
					+ class311.cameraPitch + GrandExchangeOfferUnitPriceComparator.cameraLookAtSpeed;
			if (class311.cameraPitch > var0) {
		...
		if (class311.cameraPitch > var0) {
			class311.cameraPitch -= (class311.cameraPitch - var0) * Skeleton.cameraLookAtAcceleration / 1000
					+ GrandExchangeOfferUnitPriceComparator.cameraLookAtSpeed;
			if (class311.cameraPitch < var0) {
				class311.cameraPitch = var0;
			}
		}
		...
		if (var2 > 0) {
			class110.cameraYaw = class110.cameraYaw + GrandExchangeOfferUnitPriceComparator.cameraLookAtSpeed
					+ var2 * Skeleton.cameraLookAtAcceleration / 1000;
			class110.cameraYaw &= 2047;
		}

		if (var2 < 0) {
			class110.cameraYaw -= -var2 * Skeleton.cameraLookAtAcceleration / 1000
					+ GrandExchangeOfferUnitPriceComparator.cameraLookAtSpeed;
			class110.cameraYaw &= 2047;
		}
	...
	static void revalidateWidgetScroll(Widget[] var0, Widget var1, boolean var2) {
		int var3 = var1.scrollWidth != 0 ? var1.scrollWidth * 1522996103 * 1656635959
				: var1.width * -2118454371 * 1075980981;
		int var4 = var1.scrollHeight != 0 ? var1.scrollHeight * 421465179 * 1561805779
				: var1.height * -1008795697 * 1352771375;
