...
final class class181 implements ThreadFactory {
	...
	public static PrivateChatMode method924(int var0) {
		PrivateChatMode[] var1 = new PrivateChatMode[] { PrivateChatMode.field4086, PrivateChatMode.field4083,
				PrivateChatMode.field4085 };
	...
	static final void method923(PacketBuffer var0) {
		for (int var1 = 0; var1 < Client.field413; ++var1) {
				...
				if (var5 == var3.sequence && var5 != -1) {
					...
					if (var7 == 2) {
						...
						|| Coord.SequenceDefinition_get(var5).forcedPriority >= Coord
								.SequenceDefinition_get(var3.sequence).forcedPriority) {
					var3.sequence = var5;
					var3.sequenceFrame = 0;
					var3.sequenceFrameCycle = 0;
					var3.sequenceDelay = var6;
			...
			if ((var4 & 65536) != 0) {
				var5 = var0.readIntME();
				var3.turnLeftSequence = (var5 & 1) != 0 ? var0.readUnsignedShortAdd()
						: var3.definition.turnLeftSequence * 1406295179 * 441854755;
				var3.turnRightSequence = (var5 & 2) != 0 ? var0.readUnsignedShortAddLE()
						: var3.definition.turnRightSequence * 1189253961 * -397750535;
				var3.walkSequence = (var5 & 4) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.walkSequence * 1152348467 * -1377177093;
				var3.walkBackSequence = (var5 & 8) != 0 ? var0.readUnsignedShort()
						: var3.definition.walkBackSequence * 222425699 * -274981045;
				var3.walkLeftSequence = (var5 & 16) != 0 ? var0.readUnsignedShortAddLE()
						: var3.definition.walkLeftSequence * 617555963 * -530199757;
				var3.walkRightSequence = (var5 & 32) != 0 ? var0.readUnsignedShortAddLE()
						: var3.definition.walkRightSequence * -379647223 * 498463545;
				var3.runSequence = (var5 & 64) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.runSequence * -1285996051 * -945601563;
				var3.runBackSequence = (var5 & 128) != 0 ? var0.readUnsignedShortAdd()
						: var3.definition.runBackSequence * 325542601 * -586131591;
				var3.runLeftSequence = (var5 & 256) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.runLeftSequence * -1302350385 * -1601228497;
				var3.runRightSequence = (var5 & 512) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.runRightSequence * -1419952353 * 1903000799;
				var3.crawlSequence = (var5 & 1024) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.crawlSequence * -1974099217 * 1194052623;
				var3.crawlBackSequence = (var5 & 2048) != 0 ? var0.readUnsignedShortLE()
						: var3.definition.crawlBackSequence * -1679540715 * -943021763;
				var3.crawlLeftSequence = (var5 & 4096) != 0 ? var0.readUnsignedShortAddLE()
						: var3.definition.crawlLeftSequence * -754382153 * -166464761;
				var3.crawlRightSequence = (var5 & 8192) != 0 ? var0.readUnsignedShortAdd()
						: var3.definition.crawlRightSequence * 1277541461 * 750870781;
				var3.idleSequence = (var5 & 16384) != 0 ? var0.readUnsignedShort()
						: var3.definition.idleSequence * -1822581491 * 1877440965;
			}
