...
public enum AttackOption implements class352 {
	...
	AttackOption_alwaysRightClick(1), field1069(2),

	AttackOption_hidden(3), field1071(4);
	...
	static float method590(class127 var0, float var1) {
		if (var0 != null && var0.method703() != 0) {
			if (var1 < (float) var0.field1203[0].field1165) {
				return var0.field1201 == class125.field1194 ? var0.field1203[0].field1158
						: class181.method922(var0, var1, true);
			} else if (var1 > (float) var0.field1203[var0.method703() - 1].field1165) {
				return var0.field1214 == class125.field1194 ? var0.field1203[var0.method703() - 1].field1158
				...
				if (var2 == null) {
					...
					if (var3) {
						...
						return (float) var2.field1165 != var1 && var2.field1163 != null ? var2.field1163.field1158
								: var2.field1158;
					} else {
	...
	static void readPlayerUpdate(PacketBuffer var0, int var1) {
		...
		if (var3 == 0) {
			if (var2) {
				...
				Players.Players_regions[var1] = (var4.plane << 28) + (GameEngine.baseX + var4.pathX[0] >> 13 << 14)
						+ (class178.baseY + var4.pathY[0] >> 13);
