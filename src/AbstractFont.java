			...
			for (var13 = 0; var13 < 256; ++var13) {
				if (var13 != 32 && var13 != 160) {
					for (var8 = 0; var8 < 256; ++var8) {
						if (var8 != 32 && var8 != 160) {
							this.kerning[var8 + (var13 << 8)] = (byte) method1991(var11, var12, var4, this.advances,
									var10, var13, var8);
						}
					}
				}
		...
		if (var1 == null) {
			...
			for (var14 = 0; var14 < var12; ++var14) {
				if (var8 == 0) {
					...
					this.draw0(AbstractFont_lines[var14], var2 + var4 - this.stringWidth(AbstractFont_lines[var14]),
							var13);
					...
					if (var4 == -1) {
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.Rasterizer2D_drawHorizontalLine(var2,
									var3 + (int) ((double) this.ascent * 0.7D), var13, AbstractFont_strike);
						}
			...
			if (var1.charAt(var9) != 0) {
				...
				if (var10 == '<') {
					...
					if (var6 == -1) {
						...
						if (AbstractFont_strike != -1) {
							Rasterizer2D.Rasterizer2D_drawHorizontalLine(var2,
									var3 + (int) ((double) this.ascent * 0.7D), var18, AbstractFont_strike);
						}
