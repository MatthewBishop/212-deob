...
public class Language implements class352 {
	...
	static void playSong(int var0) {
		if (var0 == -1 && !Client.playingJingle) {
			class258.method1464();
				...
				&& WorldMapSectionType.clientPreferences.getCurrentMusicVolume() != 0 && !Client.playingJingle) {
			NPC.method574(2, class308.archive6, var0, 0, WorldMapSectionType.clientPreferences.getCurrentMusicVolume(),
					false);
		}
	...
	static void performPlayerAnimation(Player var0, int var1, int var2) {
		...
		} else if (var1 == -1 || var0.sequence == -1 || Coord.SequenceDefinition_get(var1).forcedPriority >= Coord
			...
			try {
				...
				while (true) {
					...
					if (var6 == 4) {
						...
						var11 = var2[var4++];
						if (var11 != -1 && (!ParamComposition.ItemDefinition_get(var11).isMembersOnly
