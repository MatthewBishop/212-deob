		...
		if (ZoneOperation.field2518 == var0) {
			...
			if (ZoneOperation.field2522 == var0) {
				...
				if (var6 >= 0 && var31 >= 0 && var6 < 104 && var31 < 104) {
					var10 = var3 + 1;
					if (BuddyRankComparator.localPlayer.pathX[0] >= var6 - var10
							&& BuddyRankComparator.localPlayer.pathX[0] <= var10 + var6
							&& BuddyRankComparator.localPlayer.pathY[0] >= var31 - var10
							&& BuddyRankComparator.localPlayer.pathY[0] <= var10 + var31
							&& WorldMapSectionType.clientPreferences.getAreaSoundEffectsVolume() != 0 && var4 > 0
			...
			if (ZoneOperation.field2523 == var0) {
				...
				if (var31 >= 0 && var32 >= 0 && var31 < 103 && var32 < 103) {
					if (var5 == 0) {
						...
						if (var33 != null) {
							...
							if (var3 == 2) {
								var33.renderable1 = new DynamicObject(var11, 2, var4 + 4, TaskHandler.Client_plane,
										var31, var32, var9, false, var33.renderable1);
								var33.renderable2 = new DynamicObject(var11, 2, var4 + 1 & 3, TaskHandler.Client_plane,
										var31, var32, var9, false, var33.renderable2);
							} else {
								var33.renderable1 = new DynamicObject(var11, var3, var4, TaskHandler.Client_plane,
										var31, var32, var9, false, var33.renderable1);
							}
					...
					if (var5 == 1) {
						...
						if (var43 != null) {
							...
							if (var3 != 4 && var3 != 5) {
								if (var3 == 6) {
									var43.renderable1 = new DynamicObject(var11, 4, var4 + 4, TaskHandler.Client_plane,
											var31, var32, var9, false, var43.renderable1);
								} else if (var3 == 7) {
									var43.renderable1 = new DynamicObject(var11, 4, (var4 + 2 & 3) + 4,
											TaskHandler.Client_plane, var31, var32, var9, false, var43.renderable1);
								} else if (var3 == 8) {
									var43.renderable1 = new DynamicObject(var11, 4, var4 + 4, TaskHandler.Client_plane,
											var31, var32, var9, false, var43.renderable1);
									var43.renderable2 = new DynamicObject(var11, 4, (var4 + 2 & 3) + 4,
											TaskHandler.Client_plane, var31, var32, var9, false, var43.renderable2);
								}
							} else {
								var43.renderable1 = new DynamicObject(var11, 4, var4, TaskHandler.Client_plane, var31,
										var32, var9, false, var43.renderable1);
							}
					...
					if (var5 == 2) {
						...
						if (var44 != null) {
							var44.renderable = new DynamicObject(class279.Entity_unpackID(var44.tag), var3, var4,
									TaskHandler.Client_plane, var31, var32, var9, false, var44.renderable);
							return;
						}
					}
					...
					if (var5 == 3) {
						...
						if (var45 != null) {
							var45.renderable = new DynamicObject(class279.Entity_unpackID(var45.tag), 22, var4,
									TaskHandler.Client_plane, var31, var32, var9, false, var45.renderable);
							return;
						}
					}
				...
				if (var5 >= 0 && var6 >= 0 && var5 < 104 && var6 < 104) {
					...
					if (var40 != null) {
						for (TileItem var34 = (TileItem) var40.last(); var34 != null; var34 = (TileItem) var40
								.previous()) {
				...
				if (var9 >= 0 && var10 >= 0 && var9 < 104 && var10 < 104) {
					Decimator.updatePendingSpawn(TaskHandler.Client_plane, var9, var10, var31, var3, var5, var6, var2,
							0, -1);
				}
				...
				if (var4 >= 0 && var5 >= 0 && var4 < 104 && var5 < 104) {
					var4 = var4 * 128 + 64;
					var5 = var5 * 128 + 64;
					GraphicsObject var8 = new GraphicsObject(var6, TaskHandler.Client_plane, var4, var5,
							WorldMapDecorationType.getTileHeight(var4, var5, TaskHandler.Client_plane) - var31, var2,
							Client.cycle);
				...
				if (ZoneOperation.field2526 == var0) {
					...
					var5 = var38 + var12;
					var3 = var37 + var13;
					if (var12 >= 0 && var13 >= 0 && var12 < 104 && var13 < 104 && var5 >= 0 && var3 >= 0 && var5 < 104
							&& var3 < 104 && var32 != 65535) {
						var12 = var12 * 128 + 64;
						var13 = var13 * 128 + 64;
						var5 = var5 * 128 + 64;
						var3 = var3 * 128 + 64;
						Projectile var15 = new Projectile(var32, TaskHandler.Client_plane, var12, var13,
								WorldMapDecorationType.getTileHeight(var12, var13, TaskHandler.Client_plane) - var4,
								var14 + Client.cycle, var6 + Client.cycle, var10, var31, var2, var9);
						var15.setDestination(var5, var3,
								WorldMapDecorationType.getTileHeight(var5, var3, TaskHandler.Client_plane) - var9,
								var14 + Client.cycle);
					...
					if (var31 >= 0 && var32 >= 0 && var31 < 104 && var32 < 104) {
						Decimator.updatePendingSpawn(TaskHandler.Client_plane, var31, var32, var5, -1, var3, var4, 31,
								0, -1);
					}
					...
					if (ZoneOperation.field2525 == var0) {
						...
						if (var17 != null) {
							...
							int var26 = var25[var22][var24] + var25[var21][var24] + var25[var21][var23]
									+ var25[var22][var23] >> 2;
							int var27 = (var4 << 7) + (var19 << 6);
							int var28 = (var5 << 7) + (var20 << 6);
							Model var29 = var18.getModel(var12, var13, var25, var27, var26, var28);
							if (var29 != null) {
								Decimator.updatePendingSpawn(TaskHandler.Client_plane, var4, var5, var14, -1, 0, 0, 31,
										var35 + 1, var10 + 1);
