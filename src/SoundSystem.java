public class SoundSystem implements Runnable {
	...
	static int method225(int var0, Script var1, boolean var2) {
		if (var0 == 5000) {
			...
			class207.privateChatMode = class181
					.method924(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
			...
			PacketBufferNode var11 = UserComparator9.getPacketBufferNode(ClientPacket.field2449,
				...
				if (var0 == 5003) {
					...
					if (var8 != null) {
						...
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
								- 1] = var8.sender != null ? var8.sender : "";
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
								- 1] = var8.prefix != null ? var8.prefix : "";
						Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
								- 1] = var8.text != null ? var8.text : "";
						Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var8
								.isFromFriend() ? 1 : (var8.isFromIgnored() ? 2 : 0);
					} else {
					...
					if (var0 == 5004) {
						...
						if (var9 != null) {
							...
							Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
									- 1] = var9.sender != null ? var9.sender : "";
							Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
									- 1] = var9.prefix != null ? var9.prefix : "";
							Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
									- 1] = var9.text != null ? var9.text : "";
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = var9
									.isFromFriend() ? 1 : (var9.isFromIgnored() ? 2 : 0);
						} else {
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = -1;
							Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = 0;
							Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize - 1] = "";
						...
						if (var0 == 5008) {
							...
							var3 = Interpreter.Interpreter_stringStack[HealthBar.Interpreter_stringStackSize];
							String var13 = Interpreter.Interpreter_stringStack[HealthBar.Interpreter_stringStackSize
									+ 1];
							var12 = UserComparator9.getPacketBufferNode(ClientPacket.field2507,
									Client.packetWriter.isaacCipher);
							...
							if (var0 == 5016) {
								...
								var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
										- 1] = SecureRandomCallable.Messages_getHistorySize(var7);
								return 1;
							} else if (var0 == 5018) {
								var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class1
										.Messages_getLastChatID(var7);
								return 1;
							} else if (var0 == 5019) {
								var7 = Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize];
								Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize - 1] = class329
										.method1800(var7);
								return 1;
							} else if (var0 == 5020) {
								var3 = Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize];
								...
								Client.field510 = Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize]
										.toLowerCase().trim();
								return 1;
							} else if (var0 == 5022) {
								Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
							...
							if (BuddyRankComparator.localPlayer != null
									&& BuddyRankComparator.localPlayer.username != null) {
	...
	static final void method224() {
		...
		for (var1 = 0; var1 < GrandExchangeOfferOwnWorldComparator.regionLandArchives.length; ++var1) {
			if (PacketBuffer.regionMapArchiveIds[var1] != -1
					&& GrandExchangeOfferOwnWorldComparator.regionLandArchives[var1] == null) {
				GrandExchangeOfferOwnWorldComparator.regionLandArchives[var1] = ClientPreferences.archive9
						.takeFile(PacketBuffer.regionMapArchiveIds[var1], 0);
			...
			if (class123.regionLandArchiveIds[var1] != -1 && class372.regionMapArchives[var1] == null) {
				class372.regionMapArchives[var1] = ClientPreferences.archive9
						.takeFileEncrypted(class123.regionLandArchiveIds[var1], 0, ModelData0.xteaKeys[var1]);
			...
			if (!var0) {
				...
				if (!Client.isInInstance) {
					...
					for (var15 = 0; var15 < var1; ++var15) {
						...
						if (var5 != null) {
							EnumComposition.playPcmPlayers();
							Decimator.method311(var5, var3, var4, class124.timeOfPreviousKeyPress * 8 - 48,
									ArchiveDiskActionHandler.field3408 * 8 - 48, Client.collisionMaps);
						}
					}
							...
							for (var4 = 0; var4 < 13; ++var4) {
								...
								if (var6 != -1) {
									...
									for (int var12 = 0; var12 < class12.regions.length; ++var12) {
										if (class12.regions[var12] == var11
												&& GrandExchangeOfferOwnWorldComparator.regionLandArchives[var12] != null) {
											int var13 = (var9 - var3) * 8;
											int var14 = (var10 - var4) * 8;
											class220.method1179(
													GrandExchangeOfferOwnWorldComparator.regionLandArchives[var12],
													var15, var3 * 8, var4 * 8, var7, (var9 & 7) * 8, (var10 & 7) * 8,
													var8, var13, var14, Client.collisionMaps);
											var19 = true;
											break;
										}
									}
							...
							for (var4 = 0; var4 < 13; ++var4) {
								...
								if (var17 != -1) {
									...
									for (var11 = 0; var11 < class12.regions.length; ++var11) {
										if (class12.regions[var11] == var10
												&& class372.regionMapArchives[var11] != null) {
											Tiles.method449(class372.regionMapArchives[var11], var15, var3 * 8,
													var4 * 8, var6, (var8 & 7) * 8, (var9 & 7) * 8, var7, class1.scene,
				...
				if (class392.client.hasFrame()) {
					var18 = UserComparator9.getPacketBufferNode(ClientPacket.field2513,
							Client.packetWriter.isaacCipher);
