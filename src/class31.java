	...
	static final void drawModelComponents(Widget[] var0, int var1) {
		for (int var2 = 0; var2 < var0.length; ++var2) {
			...
			if (var3 != null && var3.parentId == var1 && (!var3.isIf3 || !WallDecoration.isComponentHidden(var3))) {
				int var5;
				if (var3.type == 0) {
					if (!var3.isIf3 && WallDecoration.isComponentHidden(var3)
							&& var3 != InvDefinition.mousedOverWidgetIf1) {
						continue;
					}
					...
					if (var3.sequenceId != -1 || var3.sequenceId2 != -1) {
						...
						if (var5 != -1) {
							...
							if (!var6.isCachedModelIdSet()) {
								for (var3.modelFrameCycle += Client.field504; var3.modelFrameCycle > var6.frameLengths[var3.modelFrame]; class69
