public class class130 implements class121 {
	...
	static final boolean method714(int var0, int var1, RouteStrategy var2, CollisionMap var3) {
		...
		while (var18 != var11) {
			...
			if (var16 > 0 && class212.directions[var16 - 1][var17] == 0 && (var12[var13 - 1][var14] & 19136782) == 0
			...
			if (var16 < 126 && class212.directions[var16 + 1][var17] == 0 && (var12[var13 + 2][var14] & 19136899) == 0
			...
			if (var17 > 0 && class212.directions[var16][var17 - 1] == 0 && (var12[var13][var14 - 1] & 19136782) == 0
			...
			if (var17 < 126 && class212.directions[var16][var17 + 1] == 0 && (var12[var13][var14 + 2] & 19136824) == 0
			...
			if (var16 > 0 && var17 > 0 && class212.directions[var16 - 1][var17 - 1] == 0
					&& (var12[var13 - 1][var14] & 19136830) == 0 && (var12[var13 - 1][var14 - 1] & 19136782) == 0
					&& (var12[var13][var14 - 1] & 19136911) == 0) {
				class212.bufferX[var18] = var4 - 1;
				class212.bufferY[var18] = var5 - 1;
				var18 = var18 + 1 & 4095;
			...
			if (var16 < 126 && var17 > 0 && class212.directions[var16 + 1][var17 - 1] == 0
			...
			if (var16 > 0 && var17 < 126 && class212.directions[var16 - 1][var17 + 1] == 0
			...
			if (var16 < 126 && var17 < 126 && class212.directions[var16 + 1][var17 + 1] == 0
	...
	static final void method716(boolean var0) {
		if (var0) {
			...
			Client.field392 = WorldMapSectionType.clientPreferences.method539(Login.Login_username) ? class136.field1280
					: class136.field1282;
		}
	...
	static void resumePauseWidget(int var0, int var1) {
		PacketBufferNode var2 = UserComparator9.getPacketBufferNode(ClientPacket.CONTINUE,
