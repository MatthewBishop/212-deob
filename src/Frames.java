public class Frames extends DualNode {
	...
	static final void method1250(PacketBuffer var0, int var1, Player var2, int var3) {
		...
		if ((var3 & 1) != 0) {
			...
			PlayerType var17 = (PlayerType) SpriteMask.findEnumerated(MoveSpeed.PlayerType_values(),
					var0._readUnsignedByteSub());
			...
			if (var2.username != null && var2.appearance != null) {
				...
				if (!var18 && Client.field540 == 0 && !var2.isHidden) {
					...
					Players.field1079.offset = 0;
					String var15 = AbstractFont
							.escapeBrackets(class33.method136(class279.readString(Players.field1079)));
					var2.overheadText = var15.trim();
					var2.field952 = var5 >> 8;
					var2.field945 = var5 & 255;
					var2.overheadTextCyclesRemaining = 150;
					var2.isAutoChatting = var19;
					var2.showPublicPlayerChat = var2 != BuddyRankComparator.localPlayer && var17.isUser
							&& "" != Client.field510 && var15.toLowerCase().indexOf(Client.field510) == -1;
					...
					if (var17.modIcon != -1) {
						MusicPatchNode.addGameMessage(var12,
								class7.addImageTag(var17.modIcon) + var2.username.getName(), var15);
					} else {
		...
		if ((var3 & 16384) != 0) {
			Players.playerMovementSpeeds[var1] = (MoveSpeed) SpriteMask.findEnumerated(VarcInt.method938(),
					var0.readByteAdd());
		}
	...
	static final void worldToMinimap(int var0, int var1, int var2, int var3, SpritePixels var4, SpriteMask var5) {
		...
		if (var6 > 4225 && var6 < 90000) {
			...
			byte var17 = 20;
			class136.redHintArrowSprite.method2542(var15 + (var0 + var5.width / 2 - var17 / 2),
