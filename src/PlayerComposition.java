public class PlayerComposition {
				...
				if (var18 == null) {
								...
								if (this.customisations != null) {
									...
									if (var16 != null) {
										...
										if (var16.recol != null && var22.recolorFrom != null
												&& var16.recol.length == var22.recolorTo.length) {
										...
										if (var16.retex != null && var22.retextureFrom != null
												&& var22.retextureTo.length == var16.retex.length) {
					...
					for (var13 = 0; var13 < 5; ++var13) {
						if (this.bodyColors[var13] < CollisionMap.field1830[var13].length) {
							var20.recolor(class308.field2783[var13],
									CollisionMap.field1830[var13][this.bodyColors[var13]]);
						}
	...
	public int getChatHeadId() {
		return this.npcTransformId == -1
				...
				: 305419896 + class188.getNpcDefinition(this.npcTransformId).id;
	}
	...
	static void method1640(AbstractArchive var0, AbstractArchive var1, boolean var2, int var3) {
		if (Login.clearLoginScreen) {
			...
			GrandExchangeOfferOwnWorldComparator.field353 = class368.SpriteBuffer_getIndexedSpriteByName(var1,
					"titlebutton_large", "");
			...
			Login.options_buttons_0Sprite = class368.SpriteBuffer_getIndexedSpriteByName(var1,
					"options_radio_buttons,0", "");
			ArchiveLoader.field836 = class368.SpriteBuffer_getIndexedSpriteByName(var1, "options_radio_buttons,4", "");
			Login.options_buttons_2Sprite = class368.SpriteBuffer_getIndexedSpriteByName(var1,
