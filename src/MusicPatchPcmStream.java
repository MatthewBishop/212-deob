public class MusicPatchPcmStream extends PcmStream {
		...
		if ((this.superStream.field2697[var1.field2755] & 4) != 0 && var1.field2751 < 0) {
			...
			while (true) {
				...
				if (this.superStream.field2700[var1.field2755] == 0) {
					var1.stream = RawPcmStream.method239(var1.rawSound, var10.method249(), var10.method242(),
							var10.method270());
				} else {
	...
	void method1618(MusicPatchNode var1, int var2) {
		if ((this.superStream.field2697[var1.field2755] & 4) != 0 && var1.field2751 < 0) {
			...
			if (var4 <= var2) {
				if (this.superStream.field2700[var1.field2755] == 0) {
					var1.stream = RawPcmStream.method239(var1.rawSound, var1.stream.method249(),
							var1.stream.method242(), var1.stream.method270());
				} else {
					var1.stream = RawPcmStream.method239(var1.rawSound, var1.stream.method249(), 0,
							var1.stream.method270());
					this.superStream.method1590(var1, var1.patch.field2721[var1.field2739] < 0);
				}
