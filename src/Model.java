...
public class Model extends Renderable {
	...
	public void calculateBoundsCylinder() {
		if (this.boundsType != 1) {
			...
			this.diameter = this.radius
					+ (int) (Math.sqrt((double) (this.xzRadius * this.xzRadius + this.bottomY * this.bottomY)) + 0.99D);
		}
	}
	...
	void method1271(class134 var1, int var2) {
		...
		for (int var4 = 0; var4 < var3.count; ++var4) {
			...
			if (var5 == 5 && var1.field1258 != null && var1.field1258[var4] != null && var1.field1258[var4][0] != null
			...
			for (char var7 = 0; var7 < this.indicesCount; ++var7) {
				if (this.faceColors3[var7] != -2) {
					...
					if (var1 && (var11 == -5000 || var12 == -5000 || var13 == -5000)) {
						...
						if (var2 && class156.method828(modelViewportYs[var8], modelViewportYs[var9],
								modelViewportYs[var10], var11, var12, var13, var6)) {
							class169.method898(var4);
							var2 = false;
						}

						if ((var11 - var12) * (modelViewportYs[var10] - modelViewportYs[var9])
								- (var13 - var12) * (modelViewportYs[var8] - modelViewportYs[var9]) > 0) {
							...
							if (var11 >= 0 && var12 >= 0 && var13 >= 0 && var11 <= Rasterizer3D.Rasterizer3D_clipWidth
									...
									&& var13 <= Rasterizer3D.Rasterizer3D_clipWidth) {
	...
	final void drawFace(int var1) {
		if (field2144[var1]) {
			...
			this.method1264(var1, modelViewportYs[var2], modelViewportYs[var3], modelViewportYs[var4],
					modelViewportXs[var2], modelViewportXs[var3], modelViewportXs[var4], this.faceColors1[var1],
					this.faceColors2[var1], this.faceColors3[var1]);
		}
	}
	...
	final void method1264(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9,
			int var10) {
		if (this.faceTextures != null && this.faceTextures[var1] != -1) {
			...
			if (this.faceColors3[var1] == -1) {
				Rasterizer3D.method1176(var2, var3, var4, var5, var6, var7, var8, var8, var8, field2148[var15],
						field2148[var12], field2148[var13], field2105[var15], field2105[var12], field2105[var13],
						field2109[var15], field2109[var12], field2109[var13], this.faceTextures[var1]);
			} else {
				Rasterizer3D.method1176(var2, var3, var4, var5, var6, var7, var8, var9, var10, field2148[var15],
						field2148[var12], field2148[var13], field2105[var15], field2105[var12], field2105[var13],
						field2109[var15], field2109[var12], field2109[var13], this.faceTextures[var1]);
			}
		} else {
			...
			if (this.faceColors3[var1] == -1 && var11) {
				Rasterizer3D.method1169(var2, var3, var4, var5, var6, var7, field2167[this.faceColors1[var1]],
				...
				Rasterizer3D.method1166(var2, var3, var4, var5, var6, var7, var8, var9, var10, this.overrideHue,
						this.overrideSaturation, this.overrideLuminance, this.overrideAmount);
			} else {
	...
	final void method1292(int var1) {
		...
		if (var8 >= 50) {
			...
			if (var10 >= 50) {
				...
				field2171[var4] = var2
						+ Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2148[var7] - var11) * var14 >> 16)) / 50;
				field2116[var4] = var3
						+ Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2105[var7] - var12) * var14 >> 16)) / 50;
			...
			if (var9 >= 50) {
				...
				field2171[var4] = var2
						+ Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2148[var6] - var11) * var14 >> 16)) / 50;
				field2116[var4] = var3
						+ Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2105[var6] - var12) * var14 >> 16)) / 50;
		...
		if (var9 >= 50) {
			...
			if (var8 >= 50) {
				...
				field2171[var4] = var2
						+ Rasterizer3D.Rasterizer3D_zoom * (var11 + ((field2148[var5] - var11) * var14 >> 16)) / 50;
				field2116[var4] = var3
						+ Rasterizer3D.Rasterizer3D_zoom * (var12 + ((field2105[var5] - var12) * var14 >> 16)) / 50;
		...
		if (var4 == 3) {
			if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > Rasterizer3D.Rasterizer3D_clipWidth
					|| var12 > Rasterizer3D.Rasterizer3D_clipWidth || var13 > Rasterizer3D.Rasterizer3D_clipWidth) {
		...
		if (var4 == 4) {
			if (var11 < 0 || var12 < 0 || var13 < 0 || var11 > Rasterizer3D.Rasterizer3D_clipWidth
					|| var12 > Rasterizer3D.Rasterizer3D_clipWidth || var13 > Rasterizer3D.Rasterizer3D_clipWidth
					|| field2171[3] < 0 || field2171[3] > Rasterizer3D.Rasterizer3D_clipWidth) {
				Rasterizer3D.field1962 = true;
			}
			...
			if (this.faceTextures != null && this.faceTextures[var1] != -1) {
				...
				if (this.faceColors3[var1] == -1) {
					Rasterizer3D.method1176(var14, var15, var16, var11, var12, var13, this.faceColors1[var1],
							this.faceColors1[var1], this.faceColors1[var1], field2148[var21], field2148[var18],
							field2148[var19], field2105[var21], field2105[var18], field2105[var19], field2109[var21],
							field2109[var18], field2109[var19], var22);
					Rasterizer3D.method1176(var14, var16, field2116[3], var11, var13, field2171[3],
							this.faceColors1[var1], this.faceColors1[var1], this.faceColors1[var1], field2148[var21],
							field2148[var18], field2148[var19], field2105[var21], field2105[var18], field2105[var19],
							field2109[var21], field2109[var18], field2109[var19], var22);
				} else {
					Rasterizer3D.method1176(var14, var15, var16, var11, var12, var13, field2156[0], field2156[1],
							field2156[2], field2148[var21], field2148[var18], field2148[var19], field2105[var21],
							field2105[var18], field2105[var19], field2109[var21], field2109[var18], field2109[var19],
							var22);
					Rasterizer3D.method1176(var14, var16, field2116[3], var11, var13, field2171[3], field2156[0],
							field2156[2], field2156[3], field2148[var21], field2148[var18], field2148[var19],
							field2105[var21], field2105[var18], field2105[var19], field2109[var21], field2109[var18],
							field2109[var19], var22);
				}
			} else {
				...
				if (this.faceColors3[var1] == -1 && var17) {
					...
					Rasterizer3D.method1169(var14, var15, var16, var11, var12, var13, var18, this.overrideHue,
							this.overrideSaturation, this.overrideLuminance, this.overrideAmount);
					Rasterizer3D.method1169(var14, var16, field2116[3], var11, var13, field2171[3], var18,
							this.overrideHue, this.overrideSaturation, this.overrideLuminance, this.overrideAmount);
				} else if (this.faceColors3[var1] == -1) {
					var18 = field2167[this.faceColors1[var1]];
					...
					Rasterizer3D.method1166(var14, var15, var16, var11, var12, var13, field2156[0], field2156[1],
							field2156[2], this.overrideHue, this.overrideLuminance, this.overrideSaturation,
							this.overrideAmount);
					Rasterizer3D.method1166(var14, var16, field2116[3], var11, var13, field2171[3], field2156[0],
							field2156[2], field2156[3], this.overrideHue, this.overrideLuminance,
							this.overrideSaturation, this.overrideAmount);
				} else {
					Rasterizer3D.method1156(var14, var15, var16, var11, var12, var13, field2156[0], field2156[1],
							field2156[2]);
					Rasterizer3D.method1156(var14, var16, field2116[3], var11, var13, field2171[3], field2156[0],
							field2156[2], field2156[3]);
				}
			}
		}
	...
	void method1283(int var1, class421 var2) {
		...
		float var6 = 1.0F;
		this.verticesX[var1] = (int) (var2.field3743[0] * var3 + var2.field3743[4] * var4 + var2.field3743[8] * var5
				+ var2.field3743[12] * var6);
		this.verticesY[var1] = -((int) (var2.field3743[1] * var3 + var2.field3743[5] * var4 + var2.field3743[9] * var5
				+ var2.field3743[13] * var6));
		this.verticesZ[var1] = -((int) (var2.field3743[2] * var3 + var2.field3743[6] * var4 + var2.field3743[10] * var5
				+ var2.field3743[14] * var6));
	}
								...
								if (field2164) {
									...
									if (!var38) {
										...
										if (!ViewportMouse.ViewportMouse_false0) {
											...
											byte var43 = 50;
											short var44 = 3500;
											var45 = (ViewportMouse.ViewportMouse_x - Rasterizer3D.Rasterizer3D_clipMidX)
													* var43 / Rasterizer3D.Rasterizer3D_zoom;
											var46 = (ViewportMouse.ViewportMouse_y - Rasterizer3D.Rasterizer3D_clipMidY)
													* var43 / Rasterizer3D.Rasterizer3D_zoom;
											var47 = (ViewportMouse.ViewportMouse_x - Rasterizer3D.Rasterizer3D_clipMidX)
													* var44 / Rasterizer3D.Rasterizer3D_zoom;
											var48 = (ViewportMouse.ViewportMouse_y - Rasterizer3D.Rasterizer3D_clipMidY)
													* var44 / Rasterizer3D.Rasterizer3D_zoom;
										...
										if (Math.abs(var46) > var56 + class196.field1620) {
											...
											var36 = false;
												...
												.abs(var48 * ViewportMouse.field2180 - var47 * Canvas.field70) > var45
														* Frames.field2055 + var57 * ViewportMouse.field2174) {
											var36 = false;
										} else if (Math.abs(var46 * Canvas.field70 - var48 * class391.field3637) > var56
												* ViewportMouse.field2174 + var45 * class196.field1620) {
											var36 = false;
										} else if (Math.abs(var47 * class391.field3637
												- var46 * ViewportMouse.field2180) > var56 * Frames.field2055
														+ var57 * class196.field1620) {
											var36 = false;
										} else {
											var36 = true;
										}
