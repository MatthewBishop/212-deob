...
public class WorldMap {
	...
	public void onCycle(int var1, int var2, boolean var3, int var4, int var5, int var6, int var7) {
		if (this.cacheLoader.isLoaded()) {
			...
			if (var3) {
				...
				List var10 = this.worldMapManager.method1400(this.centerTileX - var8 / 2 - 1,
	...
	public void method2252(int var1, int var2, boolean var3, boolean var4) {
		...
		if (!this.hasTarget() && (var4 || var3) && !class83.method462()) {
			...
			if (this.field3856 != -1) {
				...
				this.setWorldMapPosition(this.field3856 - (int) ((float) var7 / this.zoomTarget),
						(int) ((float) var8 / this.zoomTarget) + this.field3857, false);
			}
		} else {
			this.method2307();
		}
		...
		if (this.currentMapArea != null) {
			...
			if (this.mouseCoord != null && var3) {
				...
				if (class72.method423() && var8.getKeyPressed(82) && var8.getKeyPressed(81)) {
					...
					if (var9) {
						PacketBufferNode var12 = UserComparator9.getPacketBufferNode(ClientPacket.field2479,
	...
	void initializeWorldMapManager(WorldMapArea var1) {
		...
		this.worldMapManager = new WorldMapManager(this.mapSceneSprites, this.fonts, this.WorldMap_geographyArchive,
		...
		if (var7 < 100) {
			...
			if (!this.elementsDisabled) {
				...
				this.worldMapManager.drawElements(this.centerTileX - var8 / 2, this.centerTileY - var9 / 2,
						var8 / 2 + this.centerTileX, var9 / 2 + this.centerTileY, var1, var2, var3 + var1, var2 + var4,
						this.field3880, this.flashingElements, this.flashCycle, this.cyclesPerFlash, var10);
			}
	...
	void method2295(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (Language.field3504 != null) {
			...
			if (this.method2304(var8, var9, var13, var14, var3, var4)) {
				...
				Language.field3504.method1883(this.minCachedTileX, this.minCachedTileY, this.sprite,
	...
	public void drawOverview(int var1, int var2, int var3, int var4) {
		if (this.cacheLoader.isLoaded()) {
			...
			this.worldMapManager.drawOverview(var1, var2, var3, var4, this.flashingElements, this.flashCycle,
					this.cyclesPerFlash);
		}
	}
	...
	public void addElementMenuOptions(int var1, int var2, int var3, int var4, int var5, int var6) {
		if (this.cacheLoader.isLoaded()) {
			...
			List var9 = this.worldMapManager.method1400(this.centerTileX - var7 / 2 - 1,
				...
				do {
					...
					for (int var14 = this.menuOpcodes.length - 1; var14 >= 0; --var14) {
						if (var12.menuActions[var14] != null) {
							class110.insertMenuItemNoShift(var12.menuActions[var14], var12.menuTargetName,
