		...
		if (var2 >= 1 && var3 >= 1 && var2 <= 102 && var3 <= 102) {
			...
			if (var8 != 0L) {
				...
				if (var1 == 2) {
					...
					if (var14.interactType != 0) {
						Client.collisionMaps[var0].setFlagOffNonSquare(var2, var3, var14.sizeX, var14.sizeY, var43,
								var14.boolean1);
					}
				}
			...
			if (var4 >= 0) {
				...
				if (var6 == 22) {
					if (var17 == -1 && var16.transforms == null) {
						...
						var31 = new DynamicObject(var4, 22, var5, var13, var2, var3, var17, var16.boolean3,
								(Renderable) null);
					}
					...
					if (var6 >= 12) {
						if (var17 == -1 && var16.transforms == null) {
							...
							var31 = new DynamicObject(var4, var6, var5, var13, var2, var3, var17, var16.boolean3,
									(Renderable) null);
						}
						...
						if (var17 == -1 && var16.transforms == null) {
							...
							var31 = new DynamicObject(var4, 0, var5, var13, var2, var3, var17, var16.boolean3,
									(Renderable) null);
						}

						var44.newBoundaryObject(var0, var2, var3, var25, (Renderable) var31, (Renderable) null,
								Tiles.field824[var5], 0, var28, var30);
						if (var16.interactType != 0) {
						...
						if (var17 == -1 && var16.transforms == null) {
							...
							var31 = new DynamicObject(var4, 1, var5, var13, var2, var3, var17, var16.boolean3,
									(Renderable) null);
						}

						var44.newBoundaryObject(var0, var2, var3, var25, (Renderable) var31, (Renderable) null,
								Tiles.field832[var5], 0, var28, var30);
						if (var16.interactType != 0) {
							var15.method1100(var2, var3, var6, var5, var16.boolean1);
						}
					} else {
						...
						if (var6 == 2) {
							...
							if (var17 == -1 && var16.transforms == null) {
								...
								var32 = new DynamicObject(var4, 2, var5 + 4, var13, var2, var3, var17, var16.boolean3,
										(Renderable) null);
								var33 = new DynamicObject(var4, 2, var37, var13, var2, var3, var17, var16.boolean3,
										(Renderable) null);
							}

							var44.newBoundaryObject(var0, var2, var3, var25, (Renderable) var32, (Renderable) var33,
									Tiles.field824[var5], Tiles.field824[var37], var28, var30);
							if (var16.interactType != 0) {
								var15.method1100(var2, var3, var6, var5, var16.boolean1);
							}
						} else if (var6 == 3) {
							if (var17 == -1 && var16.transforms == null) {
								...
								var31 = new DynamicObject(var4, 3, var5, var13, var2, var3, var17, var16.boolean3,
										(Renderable) null);
							}
							...
							if (var17 == -1 && var16.transforms == null) {
								...
								var31 = new DynamicObject(var4, 4, var5, var13, var2, var3, var17, var16.boolean3,
										(Renderable) null);
							}

							var44.newWallDecoration(var0, var2, var3, var25, (Renderable) var31, (Renderable) null,
									Tiles.field824[var5], 0, 0, 0, var28, var30);
						} else {
							Object var34;
							long var38;
							if (var6 == 5) {
								...
								var44.newWallDecoration(var0, var2, var3, var25, (Renderable) var34, (Renderable) null,
										Tiles.field824[var5], 0, var37 * Tiles.field826[var5],
										var37 * Tiles.field828[var5], var28, var30);
							} else if (var6 == 6) {
								var37 = 8;
								var38 = var44.getBoundaryObjectTag(var0, var2, var3);
								if (0L != var38) {
								...
								var44.newWallDecoration(var0, var2, var3, var25, (Renderable) var34, (Renderable) null,
										256, var5, var37 * Tiles.field829[var5], var37 * Tiles.field830[var5], var28,
										var30);
							} else if (var6 == 7) {
								int var40 = var5 + 2 & 3;
								if (var17 == -1 && var16.transforms == null) {
									...
									var31 = new DynamicObject(var4, 4, var40 + 4, var13, var2, var3, var17,
											var16.boolean3, (Renderable) null);
								}

								var44.newWallDecoration(var0, var2, var3, var25, (Renderable) var31, (Renderable) null,
										256, var40, 0, 0, var28, var30);
							} else if (var6 == 8) {
								var37 = 8;
								var38 = var44.getBoundaryObjectTag(var0, var2, var3);
								if (0L != var38) {
								...
								var44.newWallDecoration(var0, var2, var3, var25, (Renderable) var34, (Renderable) var35,
										256, var5, var37 * Tiles.field829[var5], var37 * Tiles.field830[var5], var28,
										var30);
							}
						}
					...
					if (var17 == -1 && var16.transforms == null) {
						...
						var31 = new DynamicObject(var4, 10, var5, var13, var2, var3, var17, var16.boolean3,
								(Renderable) null);
					}

					if (var31 != null) {
						var44.method1240(var0, var2, var3, var25, var18, var19, (Renderable) var31,
	...
	static final void drawSpriteOnMinimap(int var0, int var1, int var2, int var3, SpritePixels var4, SpriteMask var5) {
		if (var4 != null) {
			...
			if (var7 <= 6400) {
				...
				if (var7 > 2500) {
					var4.method2540(var10 + var5.width / 2 - var4.width / 2, var5.height / 2 - var11 - var4.height / 2,
