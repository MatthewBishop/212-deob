public class class311 {
	...
	public static final short[][] field2820 = new short[][] {
	...
	public static final short[][] field2819 = new short[][] {
	...
	static final String formatItemStacks(int var0) {
		...
		if (var1.length() > 9) {
			return " " + Canvas.colorStartTag(65408) + var1.substring(0, var1.length() - 8) + "M" + " " + " (" + var1
					+ ")" + "</col>";
		} else {
			return var1.length() > 6 ? " " + Canvas.colorStartTag(16777215) + var1.substring(0, var1.length() - 4) + "K"
					+ " " + " (" + var1 + ")" + "</col>" : " " + Canvas.colorStartTag(16776960) + var1 + "</col>";
		}
	}
}
