			...
			if (var9 != var6) {
				...
				if (var15 == 2 && class1.scene.getObjectFlags(TaskHandler.Client_plane, var11, var12, var9) >= 0) {
					...
					for (PendingSpawn var19 = (PendingSpawn) Client.pendingSpawns
						...
						if (var19.plane == TaskHandler.Client_plane && var11 == var19.x && var13 == var19.y
								&& var23 == var19.id) {
							var18 = var19;
							break;
						}
					...
					if (Client.isItemSelected == 1) {
						class110.insertMenuItemNoShift("Use",
								Client.field513 + " " + "->" + " " + Canvas.colorStartTag(65535) + var17.name, 1, var23,
								var11, var13);
					} else if (Client.isSpellSelected) {
						if ((class90.selectedSpellFlags & 4) == 4) {
							class110.insertMenuItemNoShift(Client.field583,
									Client.field518 + " " + "->" + " " + Canvas.colorStartTag(65535) + var17.name, 2,
									var23, var11, var13);
						}
					} else {
						...
						if (var33 != null) {
							for (var20 = 4; var20 >= 0; --var20) {
								if ((var18 == null || var18.method500(var20)) && var33[var20] != null) {
									...
									class110.insertMenuItemNoShift(var33[var20],
											Canvas.colorStartTag(65535) + var17.name, var21, var23, var11, var13);
								}
							}
						}

						class110.insertMenuItemNoShift("Examine", Canvas.colorStartTag(65535) + var17.name, 1002,
								var17.id, var11, var13);
					}
				}
				...
				if (var15 == 1) {
					...
					if (var29.definition.size == 1 && (var29.x & 127) == 64 && (var29.y & 127) == 64) {
						for (var24 = 0; var24 < Client.npcCount; ++var24) {
							...
							if (var34 != null && var34 != var29 && var34.definition.size == 1 && var34.x == var29.x
									&& var34.y == var29.y) {
				...
				if (var15 == 0) {
					...
					if ((var30.x & 127) == 64 && (var30.y & 127) == 64) {
						for (var24 = 0; var24 < Client.npcCount; ++var24) {
							var34 = Client.npcs[Client.npcIndices[var24]];
							if (var34 != null && var34.definition.size == 1 && var34.x == var30.x
									&& var34.y == var30.y) {
								class260.addNpcToMenu(var34, Client.npcIndices[var24], var11, var13);
							}
						}
				...
				if (var15 == 3) {
					...
					if (var31 != null) {
						for (TileItem var32 = (TileItem) var31.first(); var32 != null; var32 = (TileItem) var31
								.next()) {
							ItemComposition var36 = ParamComposition.ItemDefinition_get(var32.id);
							if (Client.isItemSelected == 1) {
								class110.insertMenuItemNoShift("Use", Client.field513 + " " + "->" + " "
										+ Canvas.colorStartTag(16748608) + var36.name, 16, var32.id, var11, var13);
							} else if (Client.isSpellSelected) {
								if ((class90.selectedSpellFlags & 1) == 1) {
									class110.insertMenuItemNoShift(
											Client.field583, Client.field518 + " " + "->" + " "
													+ Canvas.colorStartTag(16748608) + var36.name,
											17, var32.id, var11, var13);
								}
							} else {
								...
								for (int var37 = 4; var37 >= 0; --var37) {
									if (var32.method593(var37)) {
										if (var26 != null && var26[var37] != null) {
											...
											class110.insertMenuItemNoShift(var26[var37],
													Canvas.colorStartTag(16748608) + var36.name, var22, var32.id, var11,
													var13);
										} else if (var37 == 2) {
											class110.insertMenuItemNoShift("Take",
													Canvas.colorStartTag(16748608) + var36.name, 20, var32.id, var11,
													var13);
										}
									}
								}

								class110.insertMenuItemNoShift("Examine", Canvas.colorStartTag(16748608) + var36.name,
										1004, var32.id, var11, var13);
							}
						}
					}
				}
