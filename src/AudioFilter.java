public class AudioFilter {
	...
	float method314(int var1, int var2, float var3) {
		float var4 = (float) this.field303[var1][0][var2]
				+ var3 * (float) (this.field303[var1][1][var2] - this.field303[var1][0][var2]);
		var4 *= 0.0015258789F;
		return 1.0F - (float) Math.pow(10.0D, (double) (-var4 / 20.0F));
	}

	float method316(int var1, int var2, float var3) {
		float var4 = (float) this.field308[var1][0][var2]
				+ var3 * (float) (this.field308[var1][1][var2] - this.field308[var1][0][var2]);
		var4 *= 1.2207031E-4F;
