...
public final class class395 implements Comparable {
	...
	static void method2073() {
		...
		for (InterfaceParent var4 = (InterfaceParent) Client.interfaceParents
				.first(); var4 != null; var4 = (InterfaceParent) Client.interfaceParents.next()) {
		...
		PacketBufferNode var5 = UserComparator9.getPacketBufferNode(ClientPacket.field2432,
