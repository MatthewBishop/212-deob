public class RawPcmStream extends PcmStream {
	...
	int method258(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field247 > 0) {
				...
				if (this.field244 == 256 && (this.field236 & 255) == 0) {
					if (ChatChannel.PcmPlayer_stereo) {
						var2 = method262(0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
								this.field239, this.field246, this.field240, 0, var6, var3, this);
					} else {
						var2 = method261(((RawSound) super.sound).samples, var1, this.field236, var2, this.field234,
								this.field245, 0, var6, var3, this);
					}
				} else if (ChatChannel.PcmPlayer_stereo) {
					var2 = method266(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
							this.field239, this.field246, this.field240, 0, var6, var3, this, this.field244, var5);
				} else {
					var2 = method265(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field234,
							this.field245, 0, var6, var3, this, this.field244, var5);
				}
			...
			if (this.field244 == 256 && (this.field236 & 255) == 0) {
				if (ChatChannel.PcmPlayer_stereo) {
					return method271(0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
							this.field239, 0, var4, var3, this);
				}

				return method257(((RawSound) super.sound).samples, var1, this.field236, var2, this.field234, 0, var4,
						var3, this);
			}

			if (ChatChannel.PcmPlayer_stereo) {
				return method276(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
						this.field239, 0, var4, var3, this, this.field244, var5);
			}

			return method237(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field234, 0, var4,
					var3, this, this.field244, var5);
		}
	}
	...
	int method255(int[] var1, int var2, int var3, int var4, int var5) {
		while (true) {
			if (this.field247 > 0) {
				...
				if (this.field244 == -256 && (this.field236 & 255) == 0) {
					if (ChatChannel.PcmPlayer_stereo) {
						var2 = method264(0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
								this.field239, this.field246, this.field240, 0, var6, var3, this);
					} else {
						var2 = method263(((RawSound) super.sound).samples, var1, this.field236, var2, this.field234,
								this.field245, 0, var6, var3, this);
					}
				} else if (ChatChannel.PcmPlayer_stereo) {
					var2 = method267(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
							this.field239, this.field246, this.field240, 0, var6, var3, this, this.field244, var5);
				} else {
					var2 = method244(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field234,
							this.field245, 0, var6, var3, this, this.field244, var5);
				}
			...
			if (this.field244 == -256 && (this.field236 & 255) == 0) {
				if (ChatChannel.PcmPlayer_stereo) {
					return method274(0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
							this.field239, 0, var4, var3, this);
				}

				return method277(((RawSound) super.sound).samples, var1, this.field236, var2, this.field234, 0, var4,
						var3, this);
			}

			if (ChatChannel.PcmPlayer_stereo) {
				return method260(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field238,
						this.field239, 0, var4, var3, this, this.field244, var5);
			}

			return method259(0, 0, ((RawSound) super.sound).samples, var1, this.field236, var2, this.field234, 0, var4,
					var3, this, this.field244, var5);
		}
	}
	...
	public static RawPcmStream createRawPcmStream(RawSound var0, int var1, int var2) {
		return var0.samples != null && var0.samples.length != 0 ? new RawPcmStream(var0,
				(int) ((long) var0.sampleRate * 256L * (long) var1 / (long) (PcmPlayer.field194 * 100)), var2 << 6)
				: null;
	}
	...
	static int method257(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7,
			RawPcmStream var8) {
		var2 >>= 8;
		var7 >>= 8;
		var4 <<= 2;
	...
	static int method271(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method274(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, RawPcmStream var10) {
		var3 >>= 8;
		var9 >>= 8;
		var5 <<= 2;
	...
	static int method237(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method276(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
	...
	static int method259(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, RawPcmStream var10, int var11, int var12) {
	...
	static int method260(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, RawPcmStream var11, int var12, int var13) {
	...
	static int method261(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			RawPcmStream var9) {
		var2 >>= 8;
		var8 >>= 8;
		var4 <<= 2;
	...
	static int method263(byte[] var0, int[] var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8,
			RawPcmStream var9) {
		var2 >>= 8;
		var8 >>= 8;
		var4 <<= 2;
	...
	static int method264(int var0, byte[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, RawPcmStream var12) {
		var3 >>= 8;
		var11 >>= 8;
		var5 <<= 2;
	...
	static int method244(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, RawPcmStream var11, int var12, int var13) {
		var11.field238 -= var11.field246 * var5;
		var11.field239 -= var11.field240 * var5;
		if (var12 == 0 || (var8 = var5 + (var10 + 256 - var4 + var12) / var12) > var9) {
	...
	static int method267(int var0, int var1, byte[] var2, int[] var3, int var4, int var5, int var6, int var7, int var8,
			int var9, int var10, int var11, int var12, RawPcmStream var13, int var14, int var15) {
		var13.field234 -= var5 * var13.field245;
