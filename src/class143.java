public class class143 {
	...
	public void method759(ClanSettings var1) {
		if (var1.field1337 == this.field1305 && this.field1303 == var1.field1357) {
			for (class140 var2 = (class140) this.field1304.last(); var2 != null; var2 = (class140) this.field1304
					.previous()) {
	...
	static final int method760() {
		if (WorldMapSectionType.clientPreferences.getRoofsHidden()) {
			...
			if (BuddyRankComparator.localPlayer.x >= 0 && BuddyRankComparator.localPlayer.y >= 0
					&& BuddyRankComparator.localPlayer.x < 13312 && BuddyRankComparator.localPlayer.y < 13312) {
				if ((Tiles.Tiles_renderFlags[TaskHandler.Client_plane][BuddyRankComparator.localPlayer.x >> 7][BuddyRankComparator.localPlayer.y >> 7]
						& 4) != 0) {
					var0 = TaskHandler.Client_plane;
				}
