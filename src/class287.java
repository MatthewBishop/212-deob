	...
	static final void menuAction(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7,
		...
		if (var2 == 1003) {
			...
			if (var15 != null) {
				...
				if (var16 != null) {
					var11 = UserComparator9.getPacketBufferNode(ClientPacket.field2460,
		...
		if (var2 == 25) {
			...
			if (var18 != null) {
				...
				TaskHandler.selectSpell(var1, var0,
						WorldMapDecorationType.Widget_unpackTargetMask(ParamComposition.getWidgetFlags(var18)), var4);
			...
			if (var2 == 50) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.OPPLAYER7,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeShort(var3);
					var10.packetBuffer.writeByte(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
					Client.packetWriter.addNode(var10);
			...
			if (var2 == 45) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.OPPLAYER2,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeByteNeg(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
					var10.packetBuffer.writeShort(var3);
					Client.packetWriter.addNode(var10);
			...
			if (var2 == 46) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.OPPLAYER3,
							Client.packetWriter.isaacCipher);
			...
			if (var2 == 48) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.OPPLAYER5,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeByteAdd(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
					var10.packetBuffer.writeShort(var3);
					Client.packetWriter.addNode(var10);
			...
			if (var2 == 44) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.OPPLAYER1,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeShort(var3);
					var10.packetBuffer.writeByteSub(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
					Client.packetWriter.addNode(var10);
			...
			if (var2 == 15) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.OPPLAYERT,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeByteSub(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
			...
			if (var2 == 58) {
				...
				if (var18 != null) {
					...
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.IF_BUTTONT,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeShort(Client.selectedSpellItemId);
			...
			if (var2 == 47) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.OPPLAYER4,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeShortAddLE(var3);
					var10.packetBuffer.writeByteNeg(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
					Client.packetWriter.addNode(var10);
			...
			if (var2 == 24) {
				...
				if (var18 != null) {
					...
					if (var13) {
						var11 = UserComparator9.getPacketBufferNode(ClientPacket.field2447,
								Client.packetWriter.isaacCipher);
			...
			if (var2 == 14) {
				...
				if (var9 != null) {
					...
					Client.destinationX = var0;
					Client.destinationY = var1;
					var10 = UserComparator9.getPacketBufferNode(ClientPacket.field2494,
							Client.packetWriter.isaacCipher);
					var10.packetBuffer.writeByteSub(Client.keyHandlerInstance.getKeyPressed(82) ? 1 : 0);
