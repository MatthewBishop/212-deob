...
public class class14 {
	...
	final ThreadPoolExecutor method51(int var1) {
		return new ThreadPoolExecutor(var1, var1, 0L, TimeUnit.MILLISECONDS, new ArrayBlockingQueue(this.field41),
				this.field43);
	}

	public class18 method50(class10 var1) {
		if (this.field42.getQueue().remainingCapacity() <= 0) {
			System.err.println("REST thread pool queue is empty\r\nThread pool size " + this.field42.getCorePoolSize()
					+ " Queue capacity " + this.field41);
	...
	static void runScript(ScriptEvent var0, int var1, int var2) {
		...
		if (var4 != null) {
			...
			label953: {
				label954: {
					try {
						...
						try {
							...
							for (var13 = 1; var13 < var3.length; ++var13) {
								if (var3[var13] instanceof Integer) {
									...
									if (var14 == -2147483643) {
										var14 = var0.widget != null ? var0.widget.childIndex * 1467332537 * 79765129
												: -1;
									}

									if (var14 == -2147483642) {
										var14 = var0.dragTarget != null ? var0.dragTarget.id * -672060695 * -1052750503
												: -1;
									}

									if (var14 == -2147483641) {
										var14 = var0.dragTarget != null
												? var0.dragTarget.childIndex * 1467332537 * 79765129
												: -1;
									}
							...
							while (true) {
								...
								if (var33 >= 100) {
									...
									var13 = var7[var20];
									Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
											- 1] = class17.getVarbit(var13);
								} else if (var33 == 27) {
									var13 = var7[var20];
									MouseRecorder.method471(var13,
											Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
								} else if (var33 == 31) {
									Interpreter.Interpreter_intStackSize -= 2;
									if (Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize] <= Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize
									...
									var21 = class364.method1937(Interpreter.Interpreter_stringStack,
											HealthBar.Interpreter_stringStackSize, var13);
									Interpreter.Interpreter_stringStack[++HealthBar.Interpreter_stringStackSize
											- 1] = var21;
								} else if (var33 == 38) {
									...
									if (var33 != 40) {
										if (var33 == 42) {
											Interpreter.Interpreter_intStack[++Interpreter.Interpreter_intStackSize
													- 1] = class248.varcs.getInt(var7[var20]);
										} else if (var33 == 43) {
											class248.varcs.setInt(var7[var20],
													Interpreter.Interpreter_intStack[--Interpreter.Interpreter_intStackSize]);
										} else if (var33 == 44) {
											var13 = var7[var20] >> 16;
											var14 = var7[var20] & '\uffff';
											...
											if (var33 == 47) {
												...
												class248.varcs.setStringOld(var7[var20],
														Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize]);
											} else if (var33 == 49) {
												...
												class248.varcs.setString(var7[var20],
														Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize]);
											} else if (var33 == 60) {
						...
						if (var30) {
							while (Interpreter.field693.size() > 0) {
								...
								class333.widgetDefaultMenuAction(var19.method584(), var19.method585(),
										var19.method587(), var19.method586(), "");
							}
							...
							if (!var9 && var2 > 0 && var10 >= var2) {
								class364.RunException_sendStackTrace("Warning: Script " + var4.field793
										+ " finished at op count " + var10 + " of max " + var1, (Throwable) null);
							}
					...
					while (Interpreter.field693.size() > 0) {
						...
						class333.widgetDefaultMenuAction(var41.method584(), var41.method585(), var41.method587(),
								var41.method586(), "");
					}
				...
				while (Interpreter.field693.size() > 0) {
					...
					class333.widgetDefaultMenuAction(var26.method584(), var26.method585(), var26.method587(),
							var26.method586(), "");
				}
				...
				if (!var9 && var2 > 0 && var10 >= var2) {
					class364.RunException_sendStackTrace(
							"Warning: Script " + var4.field793 + " finished at op count " + var10 + " of max " + var1,
							(Throwable) null);
				}
			...
			while (Interpreter.field693.size() > 0) {
				...
				class333.widgetDefaultMenuAction(var34.method584(), var34.method585(), var34.method587(),
						var34.method586(), "");
			}
