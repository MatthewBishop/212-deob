...
public final class class288 {
	...
	public static boolean method1553(AbstractArchive var0, AbstractArchive var1, AbstractArchive var2,
			MidiPcmStream var3) {
		...
		if (Login.worldSelectOpen) {
			...
			while (true) {
				if (!var43.method1090()) {
					...
					if (MouseHandler.MouseHandler_lastPressedX >= var4
							...
							&& MouseHandler.MouseHandler_lastPressedY <= 18) {
					...
					if (MouseHandler.MouseHandler_lastPressedX >= var5
							&& MouseHandler.MouseHandler_lastPressedX <= var5 + 14
							&& MouseHandler.MouseHandler_lastPressedY >= 4
							&& MouseHandler.MouseHandler_lastPressedY <= 18) {
					...
					if (MouseHandler.MouseHandler_lastPressedX >= var6
							&& MouseHandler.MouseHandler_lastPressedX <= var6 + 14
							&& MouseHandler.MouseHandler_lastPressedY >= 4
							&& MouseHandler.MouseHandler_lastPressedY <= 18) {
					...
					if (MouseHandler.MouseHandler_lastPressedX >= var45
							&& MouseHandler.MouseHandler_lastPressedX <= var45 + 14
							&& MouseHandler.MouseHandler_lastPressedY >= 4
							&& MouseHandler.MouseHandler_lastPressedY <= 18) {
					...
					if (MouseHandler.MouseHandler_lastPressedX >= var45 + 15
							&& MouseHandler.MouseHandler_lastPressedX <= var45 + 80
							&& MouseHandler.MouseHandler_lastPressedY >= 4
							&& MouseHandler.MouseHandler_lastPressedY <= 18) {
					...
					if (Login.hoveredWorldIndex != -1) {
						...
						if (Login.worldSelectPage > 0 && class12.worldSelectLeftSprite != null
								...
								&& MouseHandler.MouseHandler_lastPressedX <= class12.worldSelectLeftSprite.subWidth
								&& MouseHandler.MouseHandler_lastPressedY >= class143.canvasHeight / 2 - 50
								&& MouseHandler.MouseHandler_lastPressedY <= class143.canvasHeight / 2 + 50) {
							--Login.worldSelectPage;
						}

						if (Login.worldSelectPage < Login.worldSelectPagesCount
								&& class208.worldSelectRightSprite != null
								&& MouseHandler.MouseHandler_lastPressedX >= GameEngine.canvasWidth
										- class208.worldSelectRightSprite.subWidth - 5
								&& MouseHandler.MouseHandler_lastPressedX <= GameEngine.canvasWidth
								&& MouseHandler.MouseHandler_lastPressedY >= class143.canvasHeight / 2 - 50
								&& MouseHandler.MouseHandler_lastPressedY <= class143.canvasHeight / 2 + 50) {
							++Login.worldSelectPage;
				...
				} else if (var43.field1823 == 97 && Login.worldSelectPage < Login.worldSelectPagesCount
						&& class208.worldSelectRightSprite != null) {
					++Login.worldSelectPage;
				}
			}
			...
			if ((MouseHandler.MouseHandler_lastButton == 1
				...
				WorldMapSectionType.clientPreferences
						.getTitleMusicDisabled(!WorldMapSectionType.clientPreferences.getTitleMusicDisabled());
				...
				if (Client.gameState == 10 || Client.gameState == 11) {
					if (Language.Language_EN == class69.clientLanguage) {
						if (MouseHandler.MouseHandler_lastButton == 1
							...
							byte var9 = 35;
							if (MouseHandler.MouseHandler_lastPressedX >= var6
									&& MouseHandler.MouseHandler_lastPressedX <= var27 + var6
									&& MouseHandler.MouseHandler_lastPressedY >= var7
									&& MouseHandler.MouseHandler_lastPressedY <= var7 + var9) {
								Client.method381();
								return;
							}
						}
					...
					if (Login.loginIndex == 0) {
						...
						var47 = 291;
						if (var6 == 1 && var45 >= var48 - 75 && var45 <= var48 + 75 && var55 >= var47 - 20
								&& var55 <= var47 + 20) {
							KeyHandler.openURL(class154.method822("secure", true)
									+ "m=account-creation/g=oldscape/create_account_funnel.ws", true, false);
						}

						var48 = Login.loginBoxCenter + 80;
						if (var6 == 1 && var45 >= var48 - 75 && var45 <= var48 + 75 && var55 >= var47 - 20
								&& var55 <= var47 + 20 || var53) {
						...
						if (Login.loginIndex == 1) {
							while (true) {
								if (!var28.method1090()) {
									...
									var11 = 321;
									if (var6 == 1 && var45 >= var10 - 75 && var45 <= var10 + 75 && var55 >= var11 - 20
											&& var55 <= var11 + 20) {
										FontName.Login_promptCredentials(false);
									}
							...
							if (Login.loginIndex == 2) {
								...
								if (WorldMapSectionType.field2332 != null) {
									...
									if (var6 == 1 && var45 >= WorldMapSectionType.field2332.lowX - var48
											&& var45 <= var48 + WorldMapSectionType.field2332.lowX
											&& var55 >= var46 - 15 && var55 < var46) {
										switch (Login.field725) {
										case 1:
											Tile.setLoginResponseString("Please enter your username.",
								...
								var47 = 277;
								Login.field737 = var45 >= var48 && var45 < var48 + Message.field348 && var55 >= var47
										&& var55 < var47 + class465.field3943;
								if (var6 == 1 && Login.field737) {
									Client.Login_isUsernameRemembered = !Client.Login_isUsernameRemembered;
									if (!Client.Login_isUsernameRemembered
											&& WorldMapSectionType.clientPreferences.getUsernameToRemember() != null) {
								...
								var47 = 277;
								Login.field749 = var45 >= var48 && var45 < var48 + Message.field348 && var55 >= var47
										&& var55 < var47 + class465.field3943;
								if (var6 == 1 && Login.field749) {
									WorldMapSectionType.clientPreferences.setIsUsernameHidden(
											!WorldMapSectionType.clientPreferences.getIsUsernameHidden());
								...
								label1528: while (true) {
									...
									do {
										while (true) {
												...
												while (true) {
													while (var28.method1090()) {
														if (var28.field1823 != 13) {
															...
															var49 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
																	.indexOf(var51) != -1;
											...
											if ((var28.getKeyPressed(82) || var28.getKeyPressed(87))
													&& var28.field1823 == 67) {
									...
									try {
										...
										while (true) {
											...
											boolean var19 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
													.indexOf(var54) != -1;
											if (!var19) {
												break;
											}
								...
								if (Login.loginIndex == 3) {
									...
									var11 = 241;
									var31 = var1.method1996(0, "<col=ffd200>Download it here.</col>".length(),
											"<col=ffd200>Download it here.</col>", var10, var11);
									...
									if (Login.loginIndex == 4) {
										...
										var11 = 321;
										if (var6 == 1 && var45 >= var10 - 75 && var45 <= var10 + 75
												&& var55 >= var11 - 20 && var55 <= var11 + 20) {
										...
										if (var6 == 1 && var45 >= Login.loginBoxX + 180 - 9
												&& var45 <= Login.loginBoxX + 180 + 130 && var55 >= 263
												&& var55 <= 296) {
											Login.field750 = !Login.field750;
										}

										if (var6 == 1 && var45 >= Login.loginBoxX + 180 - 34
												&& var45 <= Login.loginBoxX + 34 + 180 && var55 >= 351
												&& var55 <= 363) {
											KeyHandler.openURL(class154.method822("secure", true)
										...
										while (var28.method1090()) {
											...
											if (var28.field1823 == 13) {
												...
												if (var28.field1823 == 85 && NetFileRequest.otp.length() > 0) {
													NetFileRequest.otp = NetFileRequest.otp.substring(0,
															NetFileRequest.otp.length() - 1);
												}
										...
										if (Login.loginIndex == 5) {
											...
											if (DevicePcmPlayerProvider.field67 != null) {
												...
												if (var6 == 1 && var45 >= DevicePcmPlayerProvider.field67.lowX - var13
														&& var45 <= var13 + DevicePcmPlayerProvider.field67.lowX
														&& var55 >= var47 - 15 && var55 < var47) {
													KeyHandler.openURL(class154.method822("secure", true)
											...
											while (var28.method1090()) {
												...
												for (var14 = 0; var14 < "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
														.length(); ++var14) {
													if (var28.field1824 == "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789!\"ï¿½$%^&*()-_=+[{]};:'@#~,<.>/?\\| "
															.charAt(var14)) {
														var49 = true;
														break;
													}
											...
											if (Login.loginIndex == 7) {
												if (class157.field1372 && !Client.onMobile) {
													...
													var47 = 231;
													var13 = var47 + 40;
													if (var6 == 1 && var45 >= var10 && var45 <= var48 && var55 >= var47
															&& var55 <= var13) {
														var15 = var10;
														int var32 = 0;
													...
													Date var60;
													if (var6 == 1 && var45 >= var14 - 75 && var45 <= var14 + 75
															&& var55 >= var50 - 20 && var55 <= var50 + 20) {
														label1371: {
															try {
																var33 = new SimpleDateFormat("ddMMyyyyHH",
																		Locale.ENGLISH);
															...
															if (var36 == null) {
																...
																if (!var20) {
																	...
																	if (!var18) {
																		...
																		class31.field89 = (int) (var36.getTime()
																				/ 86400000L - 11745L);
																	}
													...
													while (var28.method1090()) {
														...
														if (var28.field1823 == 85) {
															if (Login.field745[Login.field746] == null
																	&& Login.field746 > 0) {
																--Login.field746;
															}
													...
													if (var6 == 1 && var45 >= var10 - 75 && var45 <= var10 + 75
															&& var55 >= var11 - 20 && var55 <= var11 + 20) {
														KeyHandler.openURL(
																class154.method822("secure", true) + "m=dob/set_dob.ws",
																true, false);
														Tile.setLoginResponseString("",
												...
												if (var6 == 1 && var45 >= var10 - 75 && var45 <= var10 + 75
														&& var55 >= var11 - 20 && var55 <= var11 + 20) {
													KeyHandler.openURL("https://www.jagex.com/terms/privacy", true,
															false);
												...
												var10 = Login.loginBoxX + 180;
												var11 = 311;
												if (var28.field1823 == 84 || var28.field1823 == 13
														|| var6 == 1 && var45 >= var10 - 75 && var45 <= var10 + 75
																&& var55 >= var11 - 20 && var55 <= var11 + 20) {
													class28.method121(false);
												}
												...
												var11 = 209;
												if (var28.field1823 == 84
														|| var6 == 1 && var45 >= var10 - 109 && var45 <= var10 + 109
																&& var55 >= var11 && var55 <= var11 + 68) {
													Tile.setLoginResponseString("", "Connecting to server...", "");
												...
												var11 = 233;
												var31 = var2.method1996(0, 30,
														"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
														var10, var11);
												Bounds var29 = var2.method1996(32, 32,
														"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
														var10, var11);
												Bounds var30 = var2.method1996(70, 34,
														"<col=ffd200>terms of use</col>, <col=ffd200>privacy policy</col>, and <col=ffd200>end user licence</col>",
														var10, var11);
												var48 = var11 + 17;
												Bounds var37 = var2.method1996(0, 34,
														"<col=ffd200>agreement (EULA)</col>.", var10, var48);
												if (var6 == 1) {
													if (var31.method2170(var45, var55)) {
														...
														KeyHandler.openURL("https://www.jagex.com/terms/privacy", true,
																false);
													} else if (var30.method2170(var45, var55)
															|| var37.method2170(var45, var55)) {
														KeyHandler.openURL(
												...
												var47 = 276;
												if (var6 == 1 && var45 >= var48 - 75 && var45 <= var48 + 75
														&& var55 >= var47 - 20 && var55 <= var47 + 20) {
