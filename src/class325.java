		...
		if (var0 == 1100) {
			...
			if (var0 == 1113) {
				...
				if (var3.type == 12) {
					var11 = var3.method1758();
					if (var11 != null) {
						var11.method1716(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
				...
				if (var0 == 1126) {
					...
					var3.method1764(Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize],
							class345.urlRequester, class138.method743());
					return 1;
				} else if (var0 == 1131) {
					Interpreter.Interpreter_intStackSize -= 2;
					var3.method1748(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
							Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1]);
					return 1;
				} else if (var0 == 1132) {
					var3.method1749(Interpreter.Interpreter_stringStack[--HealthBar.Interpreter_stringStackSize],
					...
					if (var0 == 1133) {
						...
						var11 = var3.method1758();
						if (var11 != null && var11
								.method1653(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
							class69.invalidateWidget(var3);
						}
						...
						var11 = var3.method1758();
						if (var11 != null && var11
								.method1660(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
							class69.invalidateWidget(var3);
						}
						...
						var11 = var3.method1758();
						if (var11 != null && var11
								.method1661(Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize])) {
							class69.invalidateWidget(var3);
						}
						...
						if (var0 == 1140) {
							...
							Interpreter.Interpreter_intStackSize -= 2;
							var11 = var3.method1758();
							if (var11 != null && var11.method1672(
									Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize],
									Interpreter.Interpreter_intStack[Interpreter.Interpreter_intStackSize + 1])) {
								class69.invalidateWidget(var3);
							}
