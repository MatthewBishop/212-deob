public class ArchiveLoader {
	...
	static final void drawActor2d(Actor var0, int var1, int var2, int var3, int var4, int var5) {
		if (var0 != null && var0.isVisible()) {
			...
			int var9 = -2;
			if (var0.overheadText != null && (!var8 || !var0.showPublicPlayerChat && (Client.publicChatMode == 4
					|| !var0.isAutoChatting && (Client.publicChatMode == 0 || Client.publicChatMode == 3
							|| Client.publicChatMode == 1 && ((Player) var0).isFriend())))) {
				PendingSpawn.method504(var0, var0.defaultHeight);
				if (Client.viewportTempX > -1 && Client.overheadTextCount < Client.overheadTextLimit) {
					Client.overheadTextXOffsets[Client.overheadTextCount] = class7.fontBold12
					...
					if (var11 == null) {
						...
						if (var13 != null && var14 != null) {
							...
							if (Client.viewportTempX > -1) {
								...
								Rasterizer2D.Rasterizer2D_fillRectangle(var97 + var21, var22, var15 - var97, 5,
										16711680);
							}
			...
			if (var8 && var0.playerCycle == Client.cycle && SoundCache.method231((Player) var0)) {
				...
				if (var8) {
					...
					var9 += 4;
					var91.drawCentered(var90.username.getName(), var2 + Client.viewportTempX,
			...
			if (var8) {
				...
				if (var90.headIconPk != -1 || var90.headIconPrayer != -1) {
					...
					if (Client.viewportTempX > -1) {
						if (var90.headIconPk != -1) {
							var9 += 25;
							class315.headIconPkSprites[var90.headIconPk].drawTransBgAt(var2 + Client.viewportTempX - 12,
									var3 + Client.viewportTempY - var9);
						}

						if (var90.headIconPrayer != -1) {
							var9 += 25;
							class287.headIconPrayerSprites[var90.headIconPrayer].drawTransBgAt(
				...
				if (var1 >= 0 && Client.hintArrowType == 10 && var7[var1] == Client.hintArrowPlayerIndex) {
					...
					if (Client.viewportTempX > -1) {
						...
						EnumComposition.headIconHintSprites[1].drawTransBgAt(var2 + Client.viewportTempX - 12,
								var3 + Client.viewportTempY - var9);
					}
				}
			} else {
					...
					for (int var76 = 0; var76 < var94.length; ++var76) {
						if (var94[var76] >= 0 && var93[var76] >= 0) {
							...
							if (var79 != null) {
								PendingSpawn.method504(var0, var0.defaultHeight + 15);
								if (Client.viewportTempX > -1) {
									var79.drawTransBgAt(var2 + Client.viewportTempX - (var79.subWidth >> 1),
											Client.viewportTempY + (var3 - var79.subHeight) - 4);
								}
							}
						}
					}
				...
				if (Client.hintArrowType == 1 && Client.npcIndices[var1 - var75] == Client.hintArrowNpcIndex
					...
					PendingSpawn.method504(var0, var0.defaultHeight + 15);
					if (Client.viewportTempX > -1) {
						EnumComposition.headIconHintSprites[0].drawTransBgAt(var2 + Client.viewportTempX - 12,
