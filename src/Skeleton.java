		...
		if (!Client.isInInstance) {
			...
			for (var5 = (var2 - 6) / 8; var5 <= (var2 + 6) / 8; ++var5) {
				for (var6 = (var3 - 6) / 8; var6 <= (var3 + 6) / 8; ++var6) {
					...
					PacketBuffer.regionMapArchiveIds[var4] = ClientPreferences.archive9
							.getGroupId("m" + var5 + "_" + var6);
					class123.regionLandArchiveIds[var4] = ClientPreferences.archive9
					...
					for (var8 = 0; var8 < 13; ++var8) {
						...
						if (var9 != -1) {
							...
							if (var12 != -1) {
								...
								var13 = var12 >> 8 & 255;
								int var14 = var12 & 255;
								PacketBuffer.regionMapArchiveIds[var5] = ClientPreferences.archive9
										.getGroupId("m" + var13 + "_" + var14);
								class123.regionLandArchiveIds[var5] = ClientPreferences.archive9
