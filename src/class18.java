	...
	static final void method75() {
		for (PendingSpawn var0 = (PendingSpawn) Client.pendingSpawns
			...
			if (var0.endCycle == 0) {
				...
				class149.addPendingSpawnToScene(var0.plane, var0.type, var0.x, var0.y, var0.objectId, var0.field917,
						var0.field919, var0.field922);
				var0.remove();
			} else {
				...
				if (var0.startCycle == 0 && var0.x >= 1 && var0.y >= 1 && var0.x <= 102 && var0.y <= 102) {
					...
					class149.addPendingSpawnToScene(var0.plane, var0.type, var0.x, var0.y, var0.id, var0.rotation,
							var0.objectType, var0.field922);
					var0.startCycle = -1;
					if (var0.objectId == var0.id && var0.objectId == -1) {
						var0.remove();
					} else if (var0.id == var0.objectId && var0.field917 == var0.rotation
							&& var0.objectType == var0.field919) {
						var0.remove();
					}
				}
			}
