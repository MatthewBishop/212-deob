		...
		for (var10 = 0; var10 < var2; ++var10) {
			...
			if (var11 != null) {
				...
				for (var12 = 0; var12 < var11.textureTriangleCount; ++var12) {
					...
					if (var13 == 0) {
						this.texTriangleX[this.textureTriangleCount] = (short) this.method1129(var11,
								var11.texTriangleX[var12]);
						this.texTriangleY[this.textureTriangleCount] = (short) this.method1129(var11,
								var11.texTriangleY[var12]);
						this.texTriangleZ[this.textureTriangleCount] = (short) this.method1129(var11,
	...
	static void method1142(ModelData var0, ModelData var1, int var2, int var3, int var4, boolean var5) {
		...
		if (var6 >= 3 && var5) {
			for (var9 = 0; var9 < var0.faceCount; ++var9) {
				if (field1900[var0.indices1[var9]] == field1902 && field1900[var0.indices2[var9]] == field1902
						&& field1900[var0.indices3[var9]] == field1902) {
			...
			for (var9 = 0; var9 < var1.faceCount; ++var9) {
				if (field1902 == field1888[var1.indices1[var9]] && field1902 == field1888[var1.indices2[var9]]
						&& field1902 == field1888[var1.indices3[var9]]) {
