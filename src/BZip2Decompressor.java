	...
	static void BZip2Decompressor_decompress(BZip2State var0) {
		...
		while (true) {
			while (var26) {
				...
				int var52;
				byte var53;
				for (var52 = BZip2Decompressor_readBits(var22, var0); var52 > var23[var51]; var52 = var52 << 1
						| var53) {
					++var51;
				...
				while (true) {
					while (var46 != var42) {
						if (var46 != 0 && var46 != 1) {
							...
							for (var52 = BZip2Decompressor_readBits(var22,
									var0); var52 > var23[var51]; var52 = var52 << 1 | var53) {
								++var51;
								var53 = BZip2Decompressor_readNextBit(var0);
							}
